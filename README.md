  ...
  ## Week van 7 tot 13 september 2026

  ### 🐛 Bugfix

  - **E-mailsjabloon "Bevestiging cursus" — Foutmelding bij late plaatsing op een al definitieve cursus**: Wanneer een inschrijving pas ná het definitief worden van een cursus op "geplaatst" ging (bijv. vanaf de wachtlijst), werd de bevestigingsmail verstuurd zonder de variabele `$program_schedule` (de lesdagentabel) mee te geven, terwijl het sjabloon die wel gebruikt. Dit gaf een undefined-variable fout en de mail werd niet verzonden. De lesdagentabel wordt nu ook op dit tweede verzendmoment meegegeven.

  - **Contracten — Bevestigingsmail na ondertekenen kon mislukken bij een groter contract**: De bevestigingsmail die de ondertekenaar na het tekenen ontvangt, had het ondertekende contract als bijlage. Bij een wat groter bestand kon het versturen via Mailgun mislukken met een onduidelijke foutmelding. De mail bevat nu in plaats daarvan een downloadknop (90 dagen geldig) naar het ondertekende contract, net als de knop om het contract te bekijken en te ondertekenen.

  - **Beheer — Kolom "Actief" verdween uit het overzicht van e-mailsjablonen bij een lange omschrijving**: De kolom "Omschrijving" in het sjablonenoverzicht had geen limiet op de weergegeven tekstlengte, waardoor een lange omschrijving de hele rij zo breed maakte dat de kolom "Actief" (en eventuele andere kolommen erna) buiten beeld viel. De omschrijving wordt nu afgekapt op 80 tekens in het overzicht, zodat alle kolommen zichtbaar blijven.

  - **Beheer — "Stuur betaallink" toonde soms een succesmelding terwijl er geen e-mail werd verstuurd**: Als er geen actief e-mailsjabloon gekoppeld is aan het event "Betaallink", stuurde het systeem stilletjes niets — maar de knop meldde toch "De betalingslink is verstuurd". Dit gebeurt zowel bij een cursusinschrijving als bij een productverkoop. Beide plekken tonen nu een duidelijke waarschuwing ("er is geen actieve e-mailsjabloon gekoppeld") in plaats van een misleidende succesmelding wanneer dit zich voordoet.

  - **Beheer — Bedragen in overzichten stonden soms met een punt in plaats van een komma, of zonder centen**: In diverse overzichten (cursussen, programma's, producten, bestellingen, bestelregels, inschrijvingen, facturen, productverkopen) werd het bedrag met een punt als decimaalteken getoond (bijv. "€ 12.50" in plaats van "€ 12,50"), en bij productverkopen ontbraken de centen zelfs helemaal (bijv. "€ 150" in plaats van "€ 150,00"). Alle bedragen in het beheer tonen nu consistent het euroteken gevolgd door een komma en twee decimalen, met een punt als duizendtalscheiding.

  - **Beheer — Activiteitenlog van contracten toonde talloze wijzigingen die alleen "Laatste update" betroffen**: Het veld `signature_image` van een contract wordt bewust niet gelogd, maar elke keer dat het toch wijzigde (bijv. bij het ondertekenen) werd het model wel opgeslagen, waardoor "Laatste update" meeveranderde. Omdat dát veld weer niet was uitgesloten, ontstond er een activiteitenlog-regel die alleen "Laatste update" als wijziging toonde — een schijnwijziging zonder echte inhoud. Contracten slaan deze schijnwijzigingen nu over, net als bij alle andere modellen; "Laatste update" wordt nog altijd gelogd zodra er ook echt iets aan het contract verandert.

  - **Thema Gouda — Zoekbalk in de koptekst kreeg bij uitklappen een lelijke witte achtergrond, en te weinig ruimte erboven**: Zodra het zoekveld in de koptekst werd uitgeklapt (en automatisch de focus kreeg), won een generieke stijl van Bootstrap het van de eigen opmaak, waardoor het veld alsnog een witte achtergrond en blauwe focusrand kreeg in plaats van de bedoelde doorzichtige stijl — en er was te weinig lucht boven het uitgeklapte veld. Beide zijn gecorrigeerd.

  - **Beheer — Bewerk-pop-up van een inschrijving liet het gekoppelde programma zelf wijzigen**: In de "Bewerken"-pop-up van het tabblad "Inschrijvingen" bij een contact kon het programma van een inschrijving rechtstreeks aangepast worden, zonder de afhandeling (capaciteitscontrole, eventuele verrekening) die de bestaande knop "Verplaatsen" daar wél voor regelt. Dit veld toont nu alleen het huidige programma; het programma van een inschrijving wijzigen kan voortaan uitsluitend via "Verplaatsen".

  - **Beheer — Actie "Opnieuw verzenden" bij een verstuurd bericht gebruikte een kale browserbevestiging**: Op het tabblad "Correspondentie" van een contact toonde deze actie de standaard "Weet je zeker?"-melding van de browser in plaats van de gebruikelijke pop-up. Deze actie heeft nu dezelfde pop-up-stijl als alle andere bevestigingen in het beheer.

  - **Beheer — Bewerk-pop-up voor de functie/rol bij een gekoppelde organisatie of medewerker stond altijd op de eerste optie in de keuzelijst**: Op het tabblad "Organisaties" van een contact en het tabblad "Medewerkers" van een organisatie is de functie/rol van de koppeling aan te passen via een "Bewerken"-pop-up. Door een fout in de voorinvulling toonde de keuzelijst daarbij altijd de eerste optie ("Eigenaar"), ongeacht de daadwerkelijk opgeslagen functie — wie de pop-up opende en zonder iets te wijzigen op "Opslaan" klikte, veranderde de functie dus onbedoeld naar "Eigenaar". De pop-up toont nu altijd de daadwerkelijk opgeslagen functie.

  - **Beheer — Actie "Loskoppelen" (en vergelijkbare acties) in verschillende tabelweergaven gebruikte een kale browserbevestiging**: Zulke acties in de tabel-pop-ups bij bijvoorbeeld gekoppelde organisaties/medewerkers gebruikten intern nog de standaardbevestiging van de browser. Dit is nu overal binnen deze tabelweergaven dezelfde pop-up-stijl als de rest van het beheer.

  - **Beheer — Bewerkscherm van een organisatie toonde het tabblad "Algemeen" twee keer**: Door een klein verschil in een intern kenmerk stonden de velden "Aangemaakt" en "Laatste Update" op een apart, tweede tabblad dat toevallig ook "Algemeen" heette. Beide horen nu bij hetzelfde tabblad.

  - **Beheer — Actie "Anonimiseren" bij een contact gebruikte nog een kale/verouderde bevestiging**: Op het overzicht van contacten toonde deze actie een oudere pop-up-stijl, en op het bewerkscherm zelf de standaardbevestiging van de browser — beide anders dan de rest van het beheer. Beide plekken tonen nu dezelfde pop-up-stijl als overal elders.

  ### ✨ Nieuw & Verbeterd

  - **Beheer — Tabblad "Inschrijvingen" van een contact heeft nu ook de knoppen "Gestopt" en "Verplaatsen"**: Deze twee acties stonden al bij het tabblad "Inschrijvingen" van een programma, maar ontbraken bij het gelijknamige tabblad van een contact — daar was alleen "Certificaat downloaden" beschikbaar en moest voor stoppen/verplaatsen eerst naar het volledige inschrijvingsscherm genavigeerd worden. Beide knoppen staan er nu ook, met dezelfde pop-ups, regels (terugbetaling/verrekening, capaciteitscontrole) en bevestigingsmails als elders.

  - **E-mailsjabloon "Herinnering betaallink" — Werkt nu ook voor productverkopen, net als "Betaallink"**: Het automatische commando dat 3 dagen na de eerste betaallink een herinnering stuurt, keek alleen naar openstaande cursusinschrijvingen. Een betaallink voor een productverkoop (bijv. via de knop bij een productbestelling) kreeg dus nooit een herinnering, ook al gebruikt dat event dezelfde variabelen (`$course`/`$order_item` verwijzen dan naar het product en de factuur, net als bij "Betaallink"). Het commando stuurt nu ook een herinnering voor nog onbetaalde productverkopen, 3 dagen na de eerste link.
  - **E-mailsjabloon "Herinnering betaallink" — Stopt nu na 2 weken in plaats van te blijven aandringen**: Het herinneringscommando bleef tot in het oneindige een herinnering proberen te sturen zolang een betaallink openstond. Is een betaallink ouder dan 2 weken zonder dat er (volledig) betaald is, dan wordt er geen herinnering meer gestuurd: een inschrijving gaat terug naar status "Open" (uit "Betaling") zodat deze niet langer meetelt in de betaallink-herinneringen en het secretariaat het geval handmatig kan beoordelen; een productverkoop wordt intern als afgehandeld gemarkeerd zonder mail.

  - **Beheer — Consistentere tabbladen bij inschrijving en contact: tabel + pop-up in plaats van lange formulieren**: Op meerdere plekken toonden tabbladen met gekoppelde gegevens (facturen, inschrijvingen, verkopen, verstuurde e-mails) een lang, direct bewerkbaar formulier met veel velden tegelijk, of juist alleen een kale, niet-bewerkbare tabel. Dit is nu overal hetzelfde patroon: een overzichtelijke tabel met per rij een "Acties"-menu (volledig record openen, bewerken, en waar van toepassing extra acties zoals downloaden of opnieuw versturen), en een pop-up met alleen de belangrijkste velden om iets toe te voegen of aan te passen — de rest blijft bereikbaar via het volledige scherm. Doorgevoerd bij: het tabblad "Facturen" van een inschrijving (met een knop "Factuur toevoegen" die het factuurbedrag alvast invult op basis van het nog openstaande bedrag, en waarschuwt — zonder te blokkeren — als het ingevulde bedrag hoger is dan dat openstaande bedrag), het tabblad "Inschrijvingen" van een contact (met een zoekbaar veld om een programma te kiezen, in plaats van de oude lange lijst met inschrijfvelden — status, prijs en datums blijven zichtbaar maar worden nu via het volledige scherm of de bestaande knoppen Stoppen/Verplaatsen/Annuleren gewijzigd), het tabblad "Verkopen" van een contact, het tabblad "Facturen" van een contact (hier alleen bewerken, geen nieuwe factuur aanmaken — dat gebeurt via de inschrijving of verkoop zelf), en het tabblad "Correspondentie" van een contact (nu een overzicht van verstuurde berichten met een knop "Nieuw bericht" die de schrijf-pop-up opent, in plaats van een altijd zichtbaar schrijfformulier). Bij facturen is ook een knop "Opnieuw verzenden" toegevoegd aan het overzicht van e-maillogs zelf.
  - **Beheer — Tabblad "Groepsbericht" verwijderd bij cursussen**: Het bewerkscherm van een cursus had een tabblad om een groepsbericht te sturen naar cursisten met een bepaalde status, maar deze functie was nooit afgerond (het daadwerkelijke versturen van de e-mail stond nog uitgeschakeld in de code). Groepsberichten horen op het niveau van een specifiek programma thuis (waar wél bekend is wie voor welke lesreeks is ingeschreven) en niet op het algemene cursusniveau; het tabblad en de bijbehorende code zijn daarom verwijderd. Groepsberichten via een programma en individuele berichten via een contact blijven ongewijzigd beschikbaar.
  - **Beheer — Koppelvelden "Basiscursus" en "Pagina" bij een veelgestelde vraag zoeken nu direct in de database**: Op het tabblad "Koppelingen" van een veelgestelde vraag laadden deze twee velden altijd de volledige lijst van alle cursussen en pagina's in de keuzelijst. Ze zoeken nu via een zoekopdracht naar de server terwijl je typt, en de resultaten staan alfabetisch gesorteerd.
  - **Beheer — Statusveld van een inschrijving is nu alleen-lezen**: De status van een inschrijving kon voorheen ook rechtstreeks via het veld op het bewerkscherm gewijzigd worden, naast de bestaande knoppen (Direct plaatsen, Betaling, Gestopt, Annuleren, Verplaatsen). Omdat die knoppen alle bijbehorende afhandeling al regelen (facturering, verrekening, capaciteitscontrole, bevestigingsmails) kon een rechtstreekse statuswijziging die stappen overslaan en tot een inconsistente inschrijving leiden. Het statusveld toont de huidige status nu alleen nog; wijzigen kan voortaan uitsluitend via de knoppen.
  - **Beheer — Cursus en code van een programma zijn niet meer te wijzigen zodra er inschrijvingen op staan**: Beide velden waren op het bewerkscherm van een programma altijd te wijzigen, ook nadat er al cursisten waren ingeschreven. Dat kon bestaande inschrijvingen en facturen laten verwijzen naar de verkeerde cursus of code, zonder de verrekening die de knop "Verplaatsen" bij een inschrijving wel toepast. Zodra een programma minstens één (niet-placeholder) inschrijving heeft, zijn "Cursus" en "Code" alleen nog zichtbaar, niet meer te wijzigen.
  - **Beheer — Tabblad "Algemeen" van een collectie opgesplitst in "Algemeen" en "Plaatsing"**: Het tabblad "Algemeen" bij een collectie bevatte zowel inhoudelijke velden (subtitel, themakleur, introductietekst, inhoud, uitgebreide inhoud, afbeelding) als velden die bepalen waar en hoe de collectie getoond wordt (hoofdcollectie, volgorde, "Tonen op home", "Toon in filters"). Die laatste groep staat nu op een eigen tabblad "Plaatsing", zodat "Algemeen" alleen nog de inhoud van de collectie bevat.
  - **Beheer — Blogafbeelding gebruikte de instelling voor cursusafbeeldingen**: Bij het bijsnijden van de uitgelichte afbeelding van een blogartikel werd de beeldverhouding-instelling van cursusafbeeldingen ("Cursusafbeelding Verhouding") gebruikt, waardoor deze niet los van elkaar in te stellen waren. Er is nu een eigen instelling "Blogafbeelding Verhouding" (categorie Blog), gestart met dezelfde waarde als de huidige cursusinstelling.
  - **Beheer — Contactscherm toont nu "Laatste activiteit" en "Laatste inlog"**: Op het tabblad "Algemeen" van een contact zijn twee alleen-lezen velden toegevoegd, naast "Aangemaakt" en "Laatste Update": "Laatste activiteit" (het moment dat gebruikt wordt om de GDPR inactiviteits-waarschuwings-, herinnerings- en verwijder-e-mails te bepalen) en "Laatste inlog" (de laatste keer dat dit contact daadwerkelijk op zijn/haar account heeft ingelogd).
  - **Beheer — Adresvelden van een docent verplaatst naar eigen tabblad "Persoonsgegevens"**: Adres, postcode, plaats en land stonden tussen alle andere velden op het tabblad "Algemeen" van een docent. Deze vier velden staan nu bij elkaar op een nieuw tabblad "Persoonsgegevens".
  - **Beheer — Overzicht "Productverkopen" consistenter gemaakt**: De knop "Nieuw" is verwijderd uit dit overzicht — een productverkoop wordt, net als een inschrijving, altijd aangemaakt via het tabblad "Verkopen" van het betreffende contact. De knop "Stuur link" (los in een eigen kolom "Betaallink") is vervangen door een actieknop "Stuur betaallink" bij de andere rij-acties, die net als bij inschrijvingen en facturen eerst een pop-up toont met wat er gaat gebeuren: het bedrag, en naar wie (naam + e-mailadres) de link gestuurd wordt — pas na bevestigen wordt de link daadwerkelijk verstuurd.
  - **Beheer — Contracten aanbieden en digitaal laten ondertekenen, bij een docent en bij een locatie**: Nieuw tabblad "Contracten" op het bewerkscherm van een docent en van een locatie. Daar kan een eigen PDF-contract geüpload worden, waarna de ontvanger automatisch een e-mail krijgt met een persoonlijke, 30 dagen geldige link om het contract te bekijken en direct te ondertekenen (met de muis/vinger, geen account nodig) — de link kan ook los gekopieerd worden om bijvoorbeeld via WhatsApp te versturen. Bij ondertekening wordt aan het originele document een certificaatpagina toegevoegd (naam, tijdstip, IP-adres en een documentcontrole van het origineel), en krijgt de ondertekenaar een kopie van het getekende contract per e-mail. Een docent/locatie kan meerdere contracten hebben (bijv. elk jaar een nieuw contract); een al ondertekend contract kan niet meer verwijderd worden. Dit is een aparte permissie "Ondertekenen", los van de bestaande "Docenten"/"Locaties"-rechten (en ook los van de bestaande, ongerelateerde permissie "Contracten" bij programma's), en moet aan de gewenste rollen toegekend worden via Instellingen → Rollen. Het veld "Contract type" is een keuzelijst geworden, beheerd bij Instellingen → Types (dezelfde lijst als het bestaande contractstype-veld). Vanuit het overzicht van docenten en vanuit het bewerkscherm zelf (Acties-menu) staat nu ook een snelkoppeling "Contract aanmaken" die direct de aanmaak-pop-up opent, zonder eerst naar het tabblad "Contracten" te hoeven.
  - **Beheer — Tabblad "Programma's" van een docent nu ook tabel + "Acties"-menu**: Dit tabblad toonde nog de oude, niet-klikbare tabel; het is nu hetzelfde patroon als bij een locatie (en de andere tabbladen uit de eerdere consistentie-update): een tabel met per rij een link naar het volledige programma.
  - **Beheer — Tabblad "Programma's" van een cursus nu ook tabel + "Acties"-menu**: Ook dit tabblad toonde nog de oude, niet-klikbare tabel; het is nu hetzelfde patroon als bij een docent of locatie — een tabel met per rij het programma, de locatie, de startdatum en status, met een link naar het volledige programma.
  - **Beheer — Nieuwsberichten: activiteitenlog en actie "Publiceren" toegevoegd**: Net als bij de meeste andere onderdelen wordt nu ook bijgehouden wie een nieuwsbericht heeft aangemaakt of gewijzigd, in te zien via de actie "Activiteit". Een nieuwsbericht met status "Concept" heeft daarnaast een nieuwe actie "Publiceren" (zowel in het overzicht als op het bewerkscherm) die het bericht in één klik publiceert.
  - **Beheer — "Verwijderen" van een nieuwsbericht of pagina kan meteen een doorverwijzing instellen**: De verwijder-pop-up legt nu eerst uit wat er gaat gebeuren (en dat dit niet ongedaan te maken is), en heeft een optioneel veld om de oude URL automatisch te laten doorverwijzen naar een andere pagina — zodat bezoekers die de oude link nog gebruiken niet op een "pagina niet gevonden" terechtkomen. Leeg laten verwijdert het item zoals voorheen, zonder doorverwijzing. Dit gebruikt dezelfde doorverwijzingen als het bestaande onderdeel "Redirects".
  - **Beheer — Tabbladen "Medewerkers", "Bestellingen" en "Facturen" van een organisatie nu ook tabel + pop-up**: Deze tabbladen toonden nog respectievelijk een los invoegveld en twee kale, niet-klikbare tabellen; ze zijn nu hetzelfde patroon als overal elders. "Medewerkers" heeft een tabel met de acties "Loskoppelen" (ontkoppelt de persoon van de organisatie, verwijdert het contact zelf niet) en "Bewerken" (alleen de functie is aan te passen), plus een knop om een bestaand contact te koppelen. "Bestellingen" is alleen-lezen, met een link naar de volledige bestelling. "Facturen" is — net als bij een contact — alleen te bewerken, geen nieuwe factuur aan te maken (dat gebeurt via de betreffende inschrijving of verkoop zelf). Het tabblad "Contracten" van een organisatie staat voortaan achteraan, ná "Facturen".
  - **Beheer — E-mail, telefoon, geboortedatum en de fiscale nummers (BSN/BTW/IBAN) van een docent verplaatst naar tabblad "Persoonsgegevens"**: Deze velden stonden nog tussen de overige velden op tabblad "Algemeen", terwijl het adres van een docent al eerder naar een eigen tabblad "Persoonsgegevens" was verplaatst. Ze staan nu allemaal bij elkaar op dat tabblad.
  - **Beheer — Telefoonnummers worden nu gecontroleerd bij opslaan**: Bij docenten, organisaties, contacten en locaties wordt een ingevuld telefoonnummer gecontroleerd op minimaal 10 cijfers (spaties en streepjes tellen niet mee als opmaak). Een onvolledig of ongeldig telefoonnummer geeft nu een duidelijke foutmelding in plaats van zomaar opgeslagen te worden.
  - **Beheer — Actie "Anonimiseren" waarschuwt nu voor openstaande zaken**: De bevestigings-pop-up van "Anonimiseren" bij een contact laat nu ook zien — indien van toepassing — of er nog onbetaalde facturen, niet-afgeronde inschrijvingen, of openstaande productverkopen aan dit contact hangen. Puur ter informatie, zonder de actie zelf te blokkeren.
  - **Beheer — Acties "Direct plaatsen" en "Betaling" nu ook beschikbaar vanaf status "Open"**: Deze snelle acties bij een inschrijving werkten al vanaf de statussen Intake, Wachtlijst en Controle, maar niet vanaf de gewone status "Open" — daarvoor moest eerst het volledige inschrijvingsscherm geopend worden. Beide acties zijn nu ook direct beschikbaar vanaf "Open", op dezelfde plekken (overzicht en tabblad "Inschrijvingen" bij een contact/programma).

  ## Week van 31 augustus tot 6 september 2026

  ### 🐛 Bugfix

  - **Beheer — Taalwisselaar en "niet vertaald"-melding op bewerk- en bekijkschermen bij sites met maar één taal**: Cursussen, programma's en andere vertaalbare onderdelen tonen in het beheer een taal-keuzelijst en, als een veld voor de gekozen taal nog leeg is, een melding "Dit onderdeel is niet vertaald in [taal]". Bij een site die maar één taal ondersteunt (zoals Utrecht, alleen Nederlands) is er niets om naar te wisselen en kan er dus ook nooit een andere taalversie bestaan — de keuzelijst en de melding verschenen daar toch, wat verwarrend was. Beide worden nu alleen nog getoond wanneer een site daadwerkelijk meer dan één taal heeft ingesteld.

  - **Bestel- en betaalproces — Een geannuleerd programma kon tijdens het bestellen alsnog volgeboekt raken**: Op meerdere plekken in het bestel- en betaalproces (winkelwagen toevoegen, gegevens invullen, betaallink openen, betaling afronden) werd wel gecontroleerd of een programma "gesloten" was of het maximum aantal plekken had bereikt, maar niet of het programma inmiddels was geannuleerd. Als een programma tijdens iemands bestelproces werd geannuleerd, kon de bestelling daardoor alsnog doorgezet worden. Al deze controles houden nu ook rekening met de status "geannuleerd", zodat zo'n bestelling wordt afgewezen (met de melding dat de cursus volgeboekt is) in plaats van doorgezet.
  - **Beheer — Meldingtekst in het belletje bovenin werd afgekapt met "..."**: De tekst van een melding in het uitklapmenu van het bel-icoontje kreeg een vaste maximale breedte en werd op één regel afgekapt, waardoor bij een wat langere melding alleen het eerste stuk van de zin zichtbaar was. De tekst breekt nu netjes af over meerdere regels, zodat de volledige melding leesbaar is.
  - **Beheer — Losse browsermeldingen (desktopmeldingen, ook zichtbaar met gesloten tabblad) verwijderd**: Naast het belletje bovenin bestond er ook een systeem voor browser-/desktopmeldingen (via een aan/uit-schakelaartje bij het belletje), die ook nog verschijnen als het tabblad of de browser dicht is. Dit werkte in de praktijk niet betrouwbaar en is volledig verwijderd; het belletje bovenin (met de lijst meldingen) blijft gewoon bestaan en is de enige plek voor meldingen.
  - **Beheer — Invoerveld "Ledenprijs" bij een programma was verdwenen**: Bij een eerdere opschoning van het abonnementensysteem is dit veld (en de bijbehorende kolom in de programma-lijst) per ongeluk mee verwijderd uit het beheerscherm, terwijl de ledenprijs zelf nog wel actief gebruikt wordt door het kortingensysteem (korting = reguliere prijs − ledenprijs, als een deelnemer eerder een bepaald product heeft gekocht) en zichtbaar is in de winkelwagen op de website. Het veld staat weer bij "Prijs" in het tabblad Financieel, zonder de oude (niet meer bestaande) abonnementen-rechtencontrole.
  - **Beheer — Diverse meldingen in het belletje verdwenen nooit vanzelf, ook niet nadat het probleem al was opgelost**: Een aantal meldingen (bijv. "Minimum bereikt, kan definitief worden", "Nieuwe inschrijving in controle", "Kortingspas gebruik wacht op goedkeuring", "E-mail mislukt") werd wel aangemaakt op het moment zelf, maar nooit automatisch afgevinkt op het moment dat de onderliggende situatie alsnog werd opgelost (programma definitief gemaakt, inschrijving beoordeeld, kortingspas goedgekeurd/afgekeurd, e-mail opnieuw verzonden) — de melding bleef daardoor voor altijd in de lijst staan totdat iemand hem handmatig wegklikte. Deze meldingen worden nu automatisch verwijderd zodra de bijbehorende actie is uitgevoerd. Losstaand hiervan bevatte de automatische controle die elk uur draait voor "Programma X heeft geen lesdagen" een tikfout waardoor de oude melding nooit werd opgeruimd zodra er wél lesdagen waren toegevoegd (en er bovendien elk uur een nieuwe, dubbele melding bijkwam zolang dat niet zo was) — dat is nu ook gecorrigeerd. Meldingen die al vóór deze fix zijn aangemaakt, moeten nog één keer handmatig gearchiveerd worden; nieuwe meldingen van hetzelfde type lossen zichzelf voortaan op.
  - **Beheer — Meldingenbelletje uitgebreid: volledig overzicht, archief en herstellen**: Het belletje bovenin toonde altijd maar 8 meldingen tegelijk, zonder aan te geven hoeveel er in totaal open stonden (het aantal op het rode bolletje was zelfs nooit hoger dan 8, ook al waren er méér). Er is nu een volledige "Meldingen"-pagina (via "Toon alles" onderin het belletje) met twee tabbladen: Actief en Gearchiveerd, elk met volledige tekst, tijdstip en een knop om te archiveren of juist te herstellen — archiveren is dus niet meer definitief. Een melding die door meerdere beheerders tegelijk gezien wordt (bijv. "Nieuwe inschrijving in controle") is nu ook per beheerder apart af te handelen: als iemand hem archiveert, verdwijnt hij niet meer automatisch ook bij de anderen die hem nog niet gezien hadden. Voor de zes automatische controles die elk uur draaien (programma zonder lesdagen/locatie/docent, capaciteit hoger dan ruimte, achterstallige factuur) geldt nu bovendien: een handmatig gearchiveerde melding komt niet telkens elk uur terug zolang het probleem nog niet is opgelost — pas als het daadwerkelijk is opgelost, verdwijnt hij helemaal.
  - **Beheer — Verkeerde/verouderde links in een aantal meldingen**: "De factuur ... is 14 dagen na de herinnering nog niet betaald" opende meestal de cursist in plaats van de factuur zelf; deze gaat nu altijd direct naar de factuur. "Kortingspas gebruik wacht op goedkeuring" opende het algemene bewerkscherm van de korting in plaats van het tabblad met de goedkeur-/afkeurknoppen; deze springt nu direct naar dat tabblad. "De programmacode ... wordt meerdere keren gebruikt" opende de volledige, ongefilterde programmalijst; deze opent nu de lijst gefilterd op die code (met een nieuw filter "Code" op de programmalijst). Ten slotte stond er nog een handvol verouderde meldingen "De inschrijving ... heeft nog openstaande bedragen" in de lijst — een meldingtype dat in augustus is vervangen door de factuur-melding hierboven, waarna niets de oude meldingen ooit heeft opgeruimd; die zijn nu verwijderd. Ook bleek de fix voor "Programma X heeft geen lesdagen" (zie hierboven) meldingen van vóór deze wijzigingen niet mee te nemen, waardoor zo'n al-opgeloste melding alsnog kon blijven staan — dat is nu ook gecorrigeerd, met terugwerkende kracht. Daarnaast ververste de automatische controle een melding die nog steeds gold nooit met een eventueel gecorrigeerde tekst/link — een latere codefix (zoals de link-correcties hierboven) bereikte dus alleen nieuwe meldingen, niet de melding die al in de lijst stond; dit wordt nu bij elke controle bijgewerkt.
  - **Beheer — Zoeken en bulk-archiveren toegevoegd aan het meldingenoverzicht**: De "Meldingen"-pagina heeft nu een zoekveld (zoekt in de tekst van de melding, binnen het geopende tabblad) en een selectievakje per melding — met "Alles selecteren" en een knop om alle geselecteerde meldingen in één keer te archiveren (of, op het tabblad Gearchiveerd, in één keer te herstellen).
  - **Beheer — "Minimum bereikt", "Nieuwe inschrijving in controle" en "Kortingspas..." verdwenen nog steeds niet vanzelf, ook na de eerdere fix hierboven**: Twee afzonderlijke oorzaken bleken deze meldingen alsnog te laten hangen. Ten eerste: zodra een betaling voor een inschrijving met status "controle" via de automatische factuurverwerking wordt afgerond, wordt de status stilletjes bijgewerkt op een manier die de eerdere fix niet aan het werk zette (een technische kortere weg die bewust geen extra e-mails/acties triggert) — die inschrijvingen bleven daardoor toch als "in controle" gemeld staan. Ten tweede, en breder: de eerdere fix zocht een melding op via een intern kenmerk dat pas sinds deze fix wordt bijgehouden — een melding die al vóór dat moment was aangemaakt (dus vrijwel elke op dat moment al bestaande melding) werd daardoor nooit gevonden, wat bij "Minimum bereikt: 262102" en "Nieuwe inschrijving in controle: Sita Sahti — ..." optrad. Beide oorzaken zijn nu verholpen: de factuurverwerking ruimt de melding voortaan ook zelf op, en het opruimen herkent een oudere melding voortaan ook aan de exacte meldingtekst in plaats van alleen aan dat kenmerk.

  ### ✨ Nieuw & Verbeterd

  - **E-mailsjabloon "Bevestiging cursus" — Volledig lesschema nu beschikbaar als variabele `$program_schedule`**: In de bevestigingsmail die verstuurd wordt zodra een programma definitief wordt gemaakt (event "Bevestiging cursus"/`program_confirmation`) is een nieuwe variabele `$program_schedule` beschikbaar, naast de bestaande `$course` en `$order_item`. Dit is een kant-en-klaar, stijlvol tabelletje (per lesdag de datum, dag, tijd en eventuele lesdag-opmerking, plus de — eventueel per les afwijkende — locatie, ruimte en het adres), simpelweg te tonen door `{!! $program_schedule !!}` ergens in het sjabloon te zetten. Bestaande sjablonen die deze variabele niet gebruiken blijven ongewijzigd werken; het tonen van het lesschema is een bewuste keuze die een beheerder zelf in het sjabloon toevoegt.
  - **Beheer — Actie "Annuleren" bij een inschrijving gebruikte een kale browserbevestiging in plaats van de gebruikelijke pop-up**: Bij alle andere acties op de inschrijvingenlijst (Stoppen, Verplaatsen) verschijnt een pop-up met uitleg over wat er gaat gebeuren, en waar nodig invoervelden. "Annuleren" toonde in plaats daarvan alleen de standaard "Weet je zeker?"-melding van de browser. Deze actie heeft nu dezelfde soort pop-up, met een toelichting op wat annuleren betekent (status, mail aan deelnemer, creditering, docentenlijst) en een tip om "Stoppen" te gebruiken bij gedeeltelijke creditering. Zowel de "Annuleren"- als de "Gestopt"-pop-up hebben nu ook een veld "Opmerking" gekregen waarmee direct een korte notitie meegegeven kan worden, die wordt opgeslagen bij de interne opmerkingen van de inschrijving.
  - **Homepage — Agenda-blok kon programma's tonen (of leeg blijven) zonder rekening te houden met beschikbaarheid**: Het agenda-blok op de homepage (o.a. bij Gouda) haalde de eerstvolgende programma's op basis van startdatum, zonder te filteren op status — een vol, gesloten of geannuleerd programma kon zo gewoon in de agenda verschijnen. De query houdt nu rekening met status "open", zodat alleen programma's met daadwerkelijke beschikbaarheid getoond worden.
  - **Nieuw thema: Gouda — verdere afwerking**: Bovenop de lancering van het Gouda-thema is deze week een groot aantal verbeteringen aan vormgeving, toegankelijkheid en gebruiksvriendelijkheid doorgevoerd. Op mobiel: de bannerafbeelding op collectie- en aanbodpagina's is verborgen zodat de titel direct zichtbaar is, het uitklapbare menu toont nu een zoekveld en een inlog-/"Mijn account"-link, het winkelwagenicoon staat direct in de bovenste menubalk in plaats van weggestopt in het menu, en een submenu breekt netjes af onder het menu-item in plaats van ernaast. Op de homepage: de hero-banner ondersteunt nu meerdere schuifbare slides (met vaste tekst als terugval en zonder merkbare sprong in de paginahoogte bij het laden), de blokvolgorde is aangepast ("Laatste nieuws" boven "Aanbevolen voor jou", agenda onderaan), "Aanbevolen voor jou" heeft een witte achtergrond gekregen en is hernoemd, en de statische opsomming "Cursussen / workshops / lezingen / excursies" is verwijderd uit de banners. Op de collectie- en aanbodpagina: een hoofdcollectie met subcollecties toont nu de normale collectiepagina in plaats van een aparte landingspagina, de subtitel van een collectie wordt getoond in de banner, het filterpaneel scrollt intern zodra het niet meer past, de knop "Toepassen" is pas klikbaar zodra er echt iets gewijzigd is, en de schakelaar "Alleen beschikbare cursussen tonen" volgt nu de sitebrede instelling. Verder zijn de pop-ups "Zet me op de wachtlijst" en "Geef me een seintje" weer boven de rest van de pagina komen te staan, hebben de inlog-/registratiepagina's de juiste kaartstijl gekregen, zijn koptekstniveaus gecorrigeerd voor screenreaders (waaronder de pillen "Programma"/"Locatie" boven de cursusafbeelding, die nu net als de andere pillen alleen tonen bij daadwerkelijke inhoud, en correct onder de meescrollende koptekst landen bij het klikken), ververst de bedankpagina automatisch bij een nog te verwerken betaling, en laden Font Awesome-iconen nu met `font-display: swap` zodat tekst niet tijdelijk onzichtbaar wordt tijdens het laden.
  - **Lesdagen — Vinkje "Gefactureerd" opgesplitst in "Docent gefactureerd" en "Locatie gefactureerd"**: Bij een lesdag stond één vinkje "Gefactureerd", zonder onderscheid tussen de factuur aan de docent en die aan de locatie. Dit is nu opgesplitst in twee losse vinkjes — zowel bij de lesdagen/rijen in het planningstabblad van een programma als bij een losse lesdag zelf. Bestaande lesdagen die als "gefactureerd" waren aangevinkt, hebben na de migratie beide nieuwe vinkjes aan staan. Het rapport "Sessies: Locatiefacturatie" toont nu beide kolommen apart, en het rapport "Docentfacturen" heeft er een kolom "Gefactureerd (ja/nee)" bij gekregen die "Docent gefactureerd" weerspiegelt.
  - **Beheer — Beeldverhouding van collectieafbeeldingen stond vast op 1.33, in tegenstelling tot cursussen, docenten en locaties**: Voor die andere onderdelen was al een instelling beschikbaar om de gewenste beeldverhouding voor de uploadafbeelding in te stellen; voor collecties ontbrak deze en stond de verhouding hardcoded in de code. Er is nu ook een instelling "Collectieafbeelding Verhouding" toegevoegd (standaard 1.33), zodat dit voor collecties net als bij de andere onderdelen aanpasbaar is.
  - **Beheer — Inschrijving toonde deelnemer- en betaalgegevens los van elkaar als kale invoervelden**: Op de bewerkpagina van een inschrijving stonden naam, e-mail en telefoon van de deelnemer als losse, uitgegrijsde tekstvelden, zonder dat duidelijk was wie de rekening betaalt (en of dat een bedrijf is) als dat een andere persoon is dan de deelnemer. Net als bij een productverkoop staan hier nu twee overzichtelijke, even hoge blokken naast elkaar: "Deelnemer" (naam, e-mail, telefoon van de ingeschreven cursist, met een link-icoon naar het contactprofiel) en "Betaler" (naam, e-mail, telefoon van wie de bijbehorende bestelling heeft geplaatst, aangevuld met de bedrijfsgegevens van deze inschrijving als die zijn ingevuld, met een link-icoon naar het gekoppelde bedrijfsprofiel of anders het contactprofiel).
  - **Beheer — E-mailsjabloon-keuzelijst bij een evaluatie stond niet alfabetisch gesorteerd**: Bij het aanmaken/bewerken van een evaluatie stonden de keuzelijsten voor het uitnodigings- en herinneringssjabloon in willekeurige (database-)volgorde, wat het zoeken naar het juiste sjabloon lastiger maakte. Beide keuzelijsten staan nu alfabetisch gesorteerd op de getoonde sjabloonnaam.
  - **Homepage — Blok "Aanbevolen voor jou", bijna-volgeboekte cursussen kwamen steeds bovenaan**: Zonder persoonlijke voorkeur (met name bij nieuwe, niet-ingelogde bezoekers) viel de aanbevelingsscore terug op alleen populariteit/urgentie/plekken-vol-signalen, die voor iedereen identiek zijn en van nature traag veranderen. Bovendien springt het "bijna vol"-signaal al naar een hoge waarde zodra een cursus nog maar een paar plekken over heeft, en met de kleine groepsgroottes van de VU geldt dat voor veel cursussen tegelijk — waardoor dat signaal vaker de doorslag gaf dan echte populariteit. Er is nu een kleine, per-bezoeker vaste willekeur toegevoegd die de volgorde tussen ongeveer gelijk scorende cursussen laat variëren (stabiel per bezoeker, maar anders tussen bezoekers), het gewicht van "bijna vol" is verlaagd zodat het weer een lichte tie-breaker is in plaats van een gelijkwaardige factor, populariteit weegt duidelijker zwaarder mee, en het venster waarover paginaweergaven voor de populariteitsscore worden meegeteld is verkort van 30 naar 7 dagen zodat populariteit sneller op recente interesse reageert.
  - **Homepage — Voor ingelogde studenten woog een favoriet cursus nauwelijks mee in "Aanbevolen voor jou"**: Favorieten telden intern mee voor een lager gewicht dan bestelgeschiedenis, en doordat de opgeslagen affiniteitscache vrijwel altijd als "vers genoeg" werd beschouwd (die wordt elke nacht ververst) kon een zojuist toegevoegde favoriet pas de volgende ochtend écht doorwerken. Favorieten wegen nu zwaarder mee dan bestelgeschiedenis, de cache wordt genegeerd zodra er een nieuwere favoriet bijgekomen is dan de laatste nachtelijke berekening, en het toevoegen/verwijderen van een favoriet ververst meteen ook de eigen "Aanbevolen voor jou"-lijst van die student in plaats van tot 30 minuten te wachten op de normale cache-vervaltijd.
  - **Homepage — Eén specifieke cursus kreeg structureel voorrang in "Aanbevolen voor jou", bij vrijwel elke bezoeker**: Zodra een cursus toevallig iets populairder werd, kwam hij op meer homepages te staan, wat tot meer clicks leidde, wat de populariteitsscore verder omhoog duwde — een zichzelf versterkende spiraal waarbij die ene cursus nooit meer werd ingehaald. Er zijn nu twee tegenmaatregelen: de populariteitsscore wordt niet meer afgezet tegen de allerhoogste scorende cursus (die daardoor altijd een eigen streepje voor had) maar tegen het 90e-percentiel, zodat een hele groep goed presterende cursussen samen de maximale score kan halen in plaats van er maar één; en voor een deel van de bezoekers (~35%, steeds dezelfde bezoeker consistent) wordt de nummer 1 uit de ranglijst bewust overgeslagen, zodat ook de nummers daarna regelmatig zichtbaar worden en zelf populariteit kunnen opbouwen. Bij nader onderzoek bleek een specifieke cursus (Portrettekenen) daarna nog steeds dominant, niet door de bovenstaande spiraal (het grootste deel van de bezoeken kwam niet eens via de homepage) maar doordat "bijna vol" én "moet nog aangevuld worden tot het minimum" (voor twee verschillende data van dezelfde cursus) toevallig tegelijk hoog scoorden, bovenop een toch al maximale populariteitsscore. Het gewicht van het "moet nog aangevuld worden"-signaal is daarom verlaagd naar hetzelfde niveau als eerder bij "bijna vol" is gedaan, zodat ook dit weer een lichte tie-breaker is in plaats van een blikvanger op zich.
  - **Thema Utrecht — Rapport "Cursusgegevens" toonde geen aantal inschrijvingen met status "intake"**: Het rapport had al aparte kolommen voor Geplaatst, Wachtlijst, Geannuleerd en Gestopt, maar niet voor inschrijvingen die nog in de intakefase zitten. Er is nu een kolom "Intake" toegevoegd, direct na "Geplaatst".
  - **Wacht op betaling — Geen herinnering als iemand de betaallink vergat**: Een inschrijving op status "Wacht op betaling" kreeg één keer een betaallink, maar als iemand die vergat te gebruiken gebeurde er daarna niets meer. Er wordt nu automatisch een herinnering met de betaallink verstuurd, 3 dagen na de eerste link, mits de inschrijving dan nog steeds op "Wacht op betaling" staat, de cursus nog plek heeft en er nog geen (volledige) betaling is ontvangen.
  - **Inschrijving verplaatsen — Pop-up toonde geen korting bij het bepalen van het te verrekenen bedrag**: De "Verplaatsen"-pop-up liet alleen het betaalde bedrag en de nieuwe programmaprijs zien, zonder te vermelden of er op de inschrijving al een korting was toegepast. Als er ooit al eens verrekend werd, was het daardoor moeilijk te zien wat er precies bij het betaalde bedrag hoorde. De pop-up toont nu, indien van toepassing, ook de korting (bedrag en omschrijving) van de inschrijving.

  ## Week van 24 tot 30 augustus 2026

  ### 🐛 Bugfix

  - **Programma's — Knop "Sluit inschrijving nu" sloot pas na afloop van vandaag**: De actieknop "Sluit inschrijving nu" bij programma's zette de sluitingsdatum op vandaag. Omdat een programma pas als gesloten geldt zodra de huidige datum ná de sluitingsdatum ligt, bleef inschrijven hierdoor de rest van de dag nog gewoon mogelijk. De sluitingsdatum wordt nu op gisteren gezet, zodat het programma direct als gesloten geldt.
  - **Dagelijkse VUAdmin mail — Instelling "Inschrijvingen met openstaande betalingen" miste soms een openstaande factuur**: Deze sectie van de dagelijkse mail bepaalde tot nu toe "openstaand" op basis van de aanmaakdatum van de inschrijving (minstens 6 weken oud) én pas nadat er al een betalingsherinnering was verstuurd en er sindsdien nog eens 2 weken waren verstreken. Daardoor kon een factuur die écht over de vervaldatum was — bijvoorbeeld bij een kortere betalingstermijn, of nog vóórdat er een herinnering was verstuurd — onterecht onzichtbaar blijven in de mail, ook als het om maar één factuur ging. De sectie gebruikt nu dezelfde definitie als het financieel dashboard: elke onbetaalde factuur van een geplaatste inschrijving waarvan de vervaldatum is verstreken.
  - **Moodle-synchronisatie — Docent wisselen op een programma werkte niet in Moodle**: Als de docent van een programma werd gewijzigd, werd de nieuwe docent wel als docent toegevoegd in de bijbehorende Moodle-cursus, maar bleef de oude docent daar ook gewoon als docent ingeschreven staan. De synchronisatie schrijft de oude docent nu automatisch uit zodra deze niet meer aan het programma gekoppeld is.
  - **Thema Breda — Carousel-knoppen (pijltjes en puntjes) hadden geen toegankelijke naam**: De vorige/volgende-pijltjes en de puntjes onder de carousels (bijv. bij "populair en trending" en de uitgelichte collecties) werden door Owl Carousel automatisch aangemaakt als knoppen zonder tekst — een schermlezer kondigde ze daardoor alleen aan als "knop", zonder duidelijk te maken wat de knop doet. Deze knoppen krijgen nu automatisch een `aria-label` ("Vorige", "Volgende", "Ga naar slide X") zodra een carousel wordt geïnitialiseerd of ververst.
  - **Homepage — Trage laadtijd, met name bij thema Breda**: De homepage haalde bij elk bezoek opnieuw alle content-blokken (hero-slider, collectieknoppen, tekst-met-afbeelding) rechtstreeks uit de database op, via een zoekopdracht op een kolom (`page_id`) die geen index had. Belangrijker: voor elke getoonde cursus op de homepage (uitgelichte collecties, "populair en trending") werd per gekoppeld programma tot 4 losse databasequery's uitgevoerd om de actuele status (o.a. "laatste plekken", "wachtlijst") te bepalen — bij een homepage met veel programma's, zoals bij Breda, liep dit op tot ruim 1500 extra query's per bezoek. Er is nu een index toegevoegd op `page_id`, de content-blokken worden een uur lang gecachet, en de benodigde programmagegevens (lesdata, aantal plaatsingen/wachtlijst) worden voortaan in één keer meegeladen in plaats van per programma apart opgevraagd. Deze laatste verbetering geldt voor de homepage van alle thema's die uitgelichte collecties of cursussen tonen (o.a. Breda, Demo, Utrecht, Westvoorne), al is het effect het grootst bij sites met veel programma's.
  - **Alle pagina's — Lettertype- en stylesheet-bestanden blokkeerden het eerste beeld op de pagina**: Een PageSpeed-analyse van Utrecht liet zien dat Google Fonts, Adobe TypeKit en een aantal CSS-bestanden voor widgets (metisMenu, AOS-animaties, nice-select) de pagina lieten wachten voordat er iets getoond werd, terwijl deze niet nodig zijn voor het eerste beeld. Deze bestanden worden nu op de achtergrond geladen (met een `<noscript>`-terugval voor bezoekers zonder JavaScript), zodat de kritieke opmaak (Bootstrap, fontawesome-iconen, de hero-carousel) niet langer op ze hoeft te wachten. Dit is doorgevoerd bij Utrecht, Breda, Demo, Gouda en Vudemo.
  - **Inschrijving verplaatsen — Mail "Overplaatsing cursist" toonde het oude programma in plaats van het nieuwe**: Bij het verplaatsen van een inschrijving naar een ander programma via de "Verplaatsen"-knop las de code eerst het huidige (oude) programma in om te tonen in de interne notitie, en wijzigde daarna pas het programma van de inschrijving. Doordat Laravel de eerder opgehaalde programmagegevens intern bleef hergebruiken, bevatten zowel `program` als `program_new` in de verstuurde mail alsnog het oude in plaats van het nieuwe programma. De code ververst nu de programmagegevens direct na de wijziging, zodat de mail het juiste (nieuwe) programma toont.
  - **Facturen toevoegen op inschrijving/order — Betaalmethode werd stiekem ingevuld met de eerst alfabetische optie**: Sinds betaalmethode bij nieuwe facturen bewust leeg blijft totdat er echt betaald is, klopte het niet meer dat de betaalmethode-keuzelijst bij het toevoegen van een factuur (op de inschrijving- en orderpagina) geen lege optie toonde. De browser selecteert in dat geval automatisch de eerste optie in de lijst, die vervolgens gewoon werd opgeslagen alsof die bewust gekozen was. De keuzelijsten tonen nu standaard een lege optie ("-"), zodat een nog onbekende betaalmethode ook echt leeg blijft totdat iemand er bewust iets in kiest.
  - **Nieuwsbrief-aanmelding — Al bestaande Mailchimp-contacten kregen een foutmelding ("Member Exists")**: Aanmelden voor de nieuwsbrief (o.a. bij bestellen, wachtlijst en "seintje") stuurde iemands e-mailadres altijd als nieuw contact naar Mailchimp. Als dat adres al op de lijst stond, wees Mailchimp de aanmelding af met een 400-foutmelding en werd de aanmelding stilletjes niet verwerkt. Beide plekken die met Mailchimp praten (de algemene nieuwsbrief-service en de aanmeldformulieren op de homepage) doen nu een "upsert": bestaat het contact al, dan wordt het bijgewerkt in plaats van geweigerd; bestaat het nog niet, dan wordt het zoals voorheen aangemaakt.
  - **Thema Gouda — Veelgestelde vragen — Categorielijst bleef categorieën tonen die door de zoekfilter geen vragen meer bevatten**: De categorienavigatie naast de veelgestelde vragen (op de /faq-pagina en op CMS-pagina's van het type "faq") bleef altijd alle categorieën tonen, ook als een zoekopdracht ervoor zorgde dat een categorie geen enkele zichtbare vraag meer had. Klikken op zo'n categorielink sprong dan naar een leeg, verborgen blok. De categorielijst filtert nu mee: een categorie verdwijnt uit de navigatie zodra er geen vraag in overblijft die aan de zoekopdracht voldoet.
  - **Thema Gouda — Paginatitels op pagina's zonder banner waren niet consistent**: De titel boven "Nieuws" en "Producten" gebruikte een eigen, gecentreerde opmaak die afweek van de titelstijl op andere pagina's zonder bannerafbeelding (o.a. gewone CMS-pagina's); bij Producten stond de titel bovendien onterecht in een `<div>` binnen de `<h1>`. Alle paginatitels zonder banner ("Nieuws", "Veelgestelde vragen", "Producten") gebruiken nu dezelfde titelstijl en staan links uitgelijnd. Daarnaast ontbrak er ruimte tussen de paginatekst en de docenten-/locatie-/FAQ-lijst wanneer die inline op een CMS-pagina wordt getoond (bijv. bij een pagina van het type "faq"); daar is nu dezelfde ruimte toegevoegd als bij de docenten- en locatielijst.

  ### ✨ Nieuw & Verbeterd

  - **Thema Gouda — Kaartafbeeldingen (cursussen, nieuws, locaties, docenten) kregen de herkenbare "Gouda-vorm"**: De afbeeldingen op de cursus-/productkaarten, nieuwsberichten, locaties en docenten waren steeds rechthoekig (of, bij docenten, een ronde foto) met soms afgeronde hoeken — een andere vormtaal dan de schuine categorieknoppen op de homepage. Deze kaartafbeeldingen zijn nu vierkant met dezelfde lichte schuine hoek rechtsonder als de categorieknoppen, voor een consistentere Gouda-stijl door de hele site.
  - **Thema Gouda — Locatiekaarten hadden een schaduwrand en stonden maar 2 naast elkaar**: De locatiekaarten (op de locatiepagina) hadden een subtiele slagschaduw rondom de hele kaart, wat niet meer paste bij de strakkere, vlakke kaartstijl elders op de site. Deze schaduw is verwijderd en de kaarten staan nu, net als de cursus- en nieuwskaarten, met 3 naast elkaar in plaats van 2.
  - **Thema Gouda — "Laatste nieuws"-blok miste een link naar het volledige nieuwsoverzicht**: Het blok "Laatste nieuws" op de homepage en onderaan een blogartikel toonde alleen de 3 meest recente berichten, zonder doorverwijzing naar de rest. Er staat nu een link "Bekijk alle nieuws" naast de titel van dit blok, die naar /nieuws leidt.

  - **Nieuw thema: Gouda**: Volksuniversiteit Gouda heeft een eigen, volwaardig thema gekregen (logo, kleurstelling, docentpagina met uitgelichte quote in de banner, en volledig beheerbare menu's in header en footer via Menu's — inclusief een hoofdmenu met drie niveaus diep, net zo diep als bij de andere thema's). Zoals bij ieder nieuw thema is daarbij gelet op een snelle PageSpeed-score, toegankelijkheid (o.a. focus- en schermlezer-vriendelijke menu's, voldoende kleurcontrast), een mobile-first responsive opbouw, en dezelfde moderne technische basis (Bootstrap 5) als de rest van de site.
  - **Evaluatieformulier — Formulier breder gemaakt vanwege matrixvraag, en lettergrootte/koppen afgestemd op het thema**: Het evaluatieformulier stond vast op een smalle kolom (max. 8 van de 12 kolommen), wat prima was voor de bestaande vraagtypes maar de nieuwe matrixvraag (een tabel met rijen en kolommen) onnodig krap en soms horizontaal scrollend maakte. Het formulier gebruikt nu de volledige breedte van de container, bij alle thema's. Daarnaast gebruikten de titel en de kop-vraag in het formulier de kleinere Bootstrap-stijl "h3"/"h4" in plaats van de gebruikelijke "h2"-koppenstijl van de site; dit is rechtgezet bij alle thema's. Bij Gouda en Westvoorne — waar de sitebrede tekstgrootte (22px) veel groter is dan de standaard Bootstrap-formuliervelden (16px) — krijgen labels, invoervelden en meldingen in het evaluatieformulier nu dezelfde tekstgrootte als de bestaande bestel-/afrekenformulieren op die sites, zodat het niet meer klein en inconsistent aanvoelt.
  - **Instellingen → Site — Tab "Algemeen" opende niet altijd goed, en te veel tabs**: Er waren twee tabs die allebei "Algemeen" heetten (de een met, de ander zonder icoontje) — Backpack gebruikt de tabnaam zelf als technisch ID, dus deze botsten en het tabblad werkte niet meer betrouwbaar. De vaste velden en de dynamische instellingen delen nu dezelfde tab-naam, dus er is nog maar één "Algemeen". Tegelijk zijn de tabs "Courses", "Teachers", "Faq" en "Locations" (die alleen SEO-teksten en beeldverhoudingen bevatten) en de eenmalige tab "Marketing" samengevoegd met de bestaande tab "SEO".
  - **Nieuw: Voorpagina instelbaar via Instellingen → Site**: De voorpagina (het adres zonder slug, dus "/") werd tot nu toe altijd bepaald door te zoeken naar een pagina met een lege slug — een impliciete afspraak die stuk kon gaan zodra die pagina's slug per ongeluk werd overschreven (bijv. door de titel te wijzigen). Er is nu een instelling "Voorpagina" (tab Algemeen) waarmee een beheerder expliciet kiest welke pagina op "/" getoond wordt. Bestaande sites blijven ongewijzigd werken: de instelling is automatisch gevuld met de pagina die al een lege (of "/") slug had; staat de instelling leeg, dan wordt exact als voorheen gezocht naar zo'n pagina.
  - **Nieuw: GDPR-inactiviteitsbeleid voor cursistaccounts (standaard uit)**: Er is een nieuwe, volledig optionele automatisering die langdurig inactieve cursistaccounts (geen login, inschrijving of aankoop) eerst waarschuwt, daarna herinnert, en pas daarna anonimiseert — facturen en inschrijvingen blijven, zoals wettelijk vereist, altijd bewaard. De cursist kan het account op elk moment behouden via een link in de mail. Deze automatisering staat standaard **uit**; er gebeurt dus niets totdat een beheerder dit bewust aanzet (Instellingen → Site) én de bijbehorende e-mailsjablonen activeert. Gebruik `php artisan vu:gdpr-inactivity-report` om vooraf te zien hoeveel cursisten dit raakt. Een cursist wordt nooit geanonimiseerd zonder eerst een herinneringsmail te hebben gehad — dit is een harde regel, niet alleen een kwestie van timing.
  - **Nieuw: Privacy Dashboard**: Nieuwe pagina in het beheerdersmenu (onder Security Dashboard) met een overzicht van het GDPR-inactiviteitsbeleid: huidige instellingen, hoeveel cursisten in elke fase zitten (gewaarschuwd/herinnerd/geanonimiseerd), een grafiek van cursisten per jaar van laatste contact, en wie er de komende week een waarschuwing krijgt.
  - **Programma's — Kolomvolgorde in overzicht**: De kolom "Status" stond vóór de kolom "Inschrijvingen"; deze staat nu erachter.
  - **Inschrijvingen — Betaallink versturen verplaatst naar het Acties-menu met bevestiging**: De knop "Stuur betaallink" / "Stuur 2de betaallink" stond als losse knop in een eigen kolom en verstuurde direct, zonder bevestiging. Deze actie staat nu, net als "Annuleren", "Gestopt" en "Verplaatsen", in het Acties-menu van de inschrijving en toont eerst een bevestigingsscherm met het te versturen bedrag (rekening houdend met eventuele deelbetalingen), de naam van de cursist en het e-mailadres waar de link naartoe gaat.
  - **Inschrijvingen — Status en Saldo als gekleurde badges**: De kolom "Status" toonde tot nu toe alleen platte tekst (open, geplaatst, wachtlijst, etc.); deze toont nu, net als de statuskolom bij programma's, een gekleurde badge per status. De losse "Betaallink"-kolom (die na de vorige wijziging alleen nog een "Betaald"-label toonde) is verwijderd; de kolom "Saldo" toont in plaats daarvan een gekleurde badge: groen bij een saldo van € 0, oranje bij een gedeeltelijke betaling, rood zolang er nog niets betaald is, en roze bij een negatief saldo (terug te storten). Programma's en inschrijvingen gebruiken voortaan dezelfde kleurenset.
  - **Inschrijvingen — Nieuw Saldo-filter en Cursusfilter met zoeken**: Het overzicht heeft een nieuw filter "Saldo" met de opties Betaald, Positief saldo en Negatief saldo, gebaseerd op dezelfde berekening als de gekleurde Saldo-badge. Daarnaast is er een filter "Cursus" toegevoegd waarin je op cursusnaam kunt zoeken (in plaats van uit een lange vaste lijst te moeten kiezen).
  - **Facturen — Knop om een betalingsherinnering opnieuw te versturen**: In het overzicht staat nu, naast "Herdruk PDF", een knop "Herinnering herzenden" bij elke factuur waarvoor al een herinnering is verstuurd en die nog niet betaald is. Deze verstuurt dezelfde herinneringsmail (met factuur-PDF) opnieuw via de bestaande verzendlogica en werkt de verzenddatum bij.
  - **Programma's — Kleur "Aantal inschrijvingen"-badge bij minimum nog niet/wel behaald**: Zolang het minimum aantal plaatsingen nog niet behaald was, kleurde het aantal inschrijvingen oranje; dit is nu blauw (cui-info, #0d6efd). Zodra het minimum wél behaald is (maar het maximum nog niet), is de badge nu teal (cui-teal, #20c997) in plaats van blauw.
  - **Programma's — Kleur wachtlijst-badge**: Het "+N"-label voor het aantal wachtlijst-inschrijvingen naast "Aantal inschrijvingen" was oranje; dit is nu geel (cui-yellow, #ffc107), met donkere tekst voor voldoende contrast.
  - **Programma's — Kleur controle-badge ("nog te betalen vóór plaatsen")**: Het "+N"-label voor inschrijvingen met status "Controle" (nog te betalen voordat ze geplaatst kunnen worden) was rood; dit is nu oranje (cui-orange, #fd7e14).
  - **Bestellen (zakelijk) — Controle op KVK- en BTW-nummer bij het afrekenen**: De velden KVK-nummer en BTW-nummer bij een zakelijke bestelling blijven optioneel, maar worden nu, indien ingevuld, gecontroleerd op een geldig formaat: het KVK-nummer moet uit precies 8 cijfers bestaan, het BTW-nummer moet beginnen met een landcode gevolgd door het nummer (bijv. NL123456789B01). Spaties worden automatisch verwijderd voordat er gecontroleerd wordt. Bij een ongeldig nummer verschijnt een duidelijke foutmelding en gaat de bestelling niet door.
  - **Beheerdersmenu — Email-Templates en Events verplaatst naar Instellingen**: Deze twee menu-items stonden los tussen "Logs" en "Cache legen"; ze staan nu, samen met de andere configuratie-items, onder "Instellingen".
  - **Uitnodigingen — Programmacode als link en kolom met gebruikte template**: Het overzicht toonde alleen de kale programmacode van/naar, wat lastig te herleiden was bij sites met veel gelijknamige programma's (zoals Breda). De programmacode is nu klikbaar en opent direct het bijbehorende programma; ook is er een nieuwe kolom "Template" toegevoegd die toont welk e-mailsjabloon bij de uitnodiging wordt gebruikt, eveneens als link naar het sjabloon.
  - **Evaluatieformulieren — Drie nieuwe vraagtypes: "Open vraag (tekstregel)", "Matrixvraag" en "Kopje"**: Naast de bestaande "Open vraag (tekstveld)" (meerdere regels) kan bij het opstellen van een evaluatieformulier nu ook gekozen worden voor "Open vraag (tekstregel)" — een kort antwoord (max. 255 tekens) in één invoerregel. Daarnaast is er een "Matrixvraag" toegevoegd: meerdere deelvragen/stellingen die allemaal dezelfde antwoordschaal delen (bijv. "Onvoldoende / Voldoende / Goed"), weergegeven als een tabel met keuzerondjes — zoals bekend van enquêtes. Rijen (stellingen) en kolommen (schaal) zijn vrij in te vullen per vraag. Elk antwoord op een matrixvraag wordt apart opgeslagen (per stelling) en verschijnt zo ook los terug in de Excel-export en het antwoordenoverzicht van een individuele reactie. Tot slot is er "Kopje" toegevoegd: puur een tussenkop (bijv. "Vragen over de Docent", "Jouw gegevens") om langere formulieren overzichtelijker in secties op te delen — geen invoerveld, geen opgeslagen antwoord, en verschijnt dus ook nergens in de export.
  - **Evaluatieformulieren — Twee nieuwe marketing-koppelingen: "Toestemming publicatie" en "Weergavenaam"**: Naast de bestaande koppelingen (cijfer/opmerking per docent, cursus en locatie) kan een vraag nu ook gekoppeld worden aan "Toestemming publicatie" — zo is in het antwoordenoverzicht en de Excel-export in één oogopslag te zien of een deelnemer akkoord is met het gebruik van zijn/haar reactie op de website, als hulp bij de (nog altijd handmatige) publicatiekeuze. En aan "Weergavenaam": een vraag als "Welke naam mogen we onder je recensie zetten (laat leeg voor Anoniem)" kan hieraan gekoppeld worden, zodat deelnemers niet automatisch onder hun echte naam gepubliceerd worden. Bij thema Utrecht, waar recensies op de homepage/cursus-/docentpagina getoond worden, wordt voortaan alleen deze opgegeven weergavenaam gebruikt (en anders "Anoniem") — niet langer de echte voornaam van de cursist. Beide nieuwe velden zijn ook zichtbaar en bewerkbaar in het antwoordenoverzicht, net als de bestaande quotes.
  - **Locaties — Nieuwe detailpagina, net als bij docenten**: Locaties hadden nog geen eigen pagina; het overzicht (/locatie) toonde alle informatie direct op de kaart. Locaties hebben nu een detailpagina (/locatie/{slug}, net als /docent/{slug}) met de locatiefoto, een nieuw invulbaar veld "Introductietekst" (Locaties → locatie bewerken), het adres met een link "Bekijk op kaart", de volledige inhoud, en — net als bij een docent — een slider "Cursussen op deze locatie" met de eerstvolgende programma's die op die locatie gegeven worden. De slug wordt automatisch gegenereerd op basis van de naam (geen apart invulveld, zoals bij docenten en cursussen); bestaande locaties hebben bij het uitrollen automatisch een slug gekregen op basis van hun huidige naam. Vooralsnog alleen doorgevoerd bij thema Gouda: de titel en foto op de locatiekaart in het overzicht linken daar nu door naar de detailpagina, en de kaart toont de nieuwe introductietekst in plaats van de volledige inhoud.

  ## Week van 17 tot 23 augustus 2026
  ...
  - **Thema Breda — Uitloggen ontbrak in menu voor ingelogde cursisten**: Als enige thema toonde de header van Breda geen "Uitloggen"-link (en geen "Inloggen" wanneer nog niet ingelogd) — het accountpictogram ging altijd naar het dashboard, ongeacht of je ingelogd was. Zowel in de desktopmenubalk als in het mobiele menu wordt nu, net als bij de andere thema's, "Inloggen" getoond als je niet ingelogd bent en "Mijn account" + "Uitloggen" als je wel ingelogd bent.
  - **Winkelwagen — Aantal in het menu-icoontje kon (kort) afwijken van het echte aantal in de winkelwagen**: Het aantal op het winkelwagen-icoontje in de header (en, bij thema Vudemo, ook het mini-winkelwagenoverzicht) werd opgehaald met een simpelere zoekopdracht dan de winkelwagenpagina zelf gebruikt. Daardoor kon het icoontje, met name kort na het afronden van een bestelling, nog even het aantal van de zojuist afgesloten (betaalde/voltooide) winkelwagen tonen in plaats van 0 of het aantal van de nieuwe winkelwagen. Beide plekken gebruiken nu dezelfde logica als de winkelwagenpagina, dus het icoontje blijft synchroon met de daadwerkelijke inhoud.
  - **VUAdmin-dashboard — Eerste mededeling in de accordion stond altijd standaard open**: Bij de mededelingen op het dashboard was steeds de bovenste (nieuwste) mededeling automatisch uitgeklapt, ongeacht of je die al gelezen had. Alle mededelingen staan nu standaard ingeklapt.

  ### ✨ Nieuw & Verbeterd

  - **Dagelijkse VUAdmin mail — Nieuwe controle op lesdagen die op een vrije dag zijn komen te vallen**: Een vrije dag (bijv. vakantie of sluiting) instellen bij een docent, locatie of voor de hele VU voorkomt tot nu toe alleen dat er ná dat moment nog nieuwe lesdagen op die datum ingepland worden — lesdagen die al eerder waren aangemaakt bleven gewoon staan, ook als ze inmiddels op zo'n vrije dag vallen. De dagelijkse VUAdmin-mail signaleert dit voortaan: voor elke toekomstige lesdag die samenvalt met een vrije dag van de betreffende docent (alleen als die docent die les ook daadwerkelijk geeft), van de betreffende locatie (alleen als de les ook daadwerkelijk op die locatie plaatsvindt) of met een algemene VU-brede vrije dag, verschijnt een regel met het programma, de lesdatum en de reden, met een directe link naar het programma zodat de lesdagen daar opnieuw gegenereerd kunnen worden. Deze melding is, net als de andere onderdelen van de dagelijkse mail, uit te zetten via Instellingen → Adminmail.

  - **Wachtlijst en seintje — Maken nu ook automatisch een contact aan**: Bij het invullen van een wachtlijst- of seintje-formulier op de website werd de naam, het e-mailadres en telefoonnummer alleen bij de betreffende aanmelding zelf opgeslagen. Is er nog geen contact met dit e-mailadres bekend, dan wordt er nu automatisch een nieuw contact voor aangemaakt (met naam, e-mailadres en telefoonnummer als enige gegevens); is het e-mailadres al bekend, dan wordt de aanmelding gekoppeld aan het bestaande contact.

  - **Inschrijvingen — Nieuwe knop "Gestopt" met gedeeltelijke terugbetaling**: Naast "Annuleren" (volledige terugbetaling) staat bij inschrijvingen met status "Geplaatst" nu ook een knop "Gestopt". Deze opent een popup waarin het al betaalde bedrag getoond wordt en waar zelf ingevuld kan worden hoeveel daarvan teruggestort moet worden (standaard het volledige betaalde bedrag, maximaal dat bedrag). Na "Opslaan en mails versturen" wordt de inschrijving op "Gestopt" gezet (waarmee automatisch de bevestigingsmail(s) naar deelnemer en docent verstuurt, zoals al langer het geval was bij een statuswijziging naar "Gestopt"), eventuele nog openstaande, nog niet betaalde termijnen worden gecrediteerd, en bij een terugbetaling hoger dan €0 wordt een creditnota aangemaakt die — anders dan bij "Annuleren" — automatisch per mail naar de deelnemer gestuurd wordt.

  - **Inschrijvingen — Nieuwe knop "Verplaatsen" met eigen verrekenbedrag**: Een inschrijving naar een ander programma verplaatsen kon al door het programma op het bewerkscherm te wijzigen; daar staat sinds deze update ook een knop "Verplaatsen" voor bij inschrijvingen met status "Geplaatst". De popup toont het al betaalde bedrag en de prijs van het gekozen nieuwe programma, en vult een veld "Te verrekenen" standaard met het verschil daartussen — dit bedrag kan positief (extra te betalen) of negatief (terug te storten) worden aangepast voordat er opgeslagen wordt. Na "Opslaan en mails versturen" wordt de inschrijving naar het nieuwe programma verplaatst (met automatische bevestigingsmail en nieuwe programmadetails, zoals al het geval was bij het wijzigen van het programma), komt er een notitie over de verplaatsing en het verrekenbedrag bij de (interne) Opmerkingen van de inschrijving, en wordt voor het verrekenbedrag een nieuwe factuur (bij een positief bedrag, met betaallink) of creditnota (bij een negatief bedrag) aangemaakt en automatisch naar de deelnemer gemaild. Het veld "Nieuw programma" is een zoekveld geworden (typen op programmacode of cursusnaam) in plaats van een volledige lijst van alle programma's ooit, en toont alleen programma's die nog niet afgerond zijn. De uitleg in de popup zelf is verduidelijkt: kortere zinnen, en een expliciete vermelding dat een eventuele betaallink of creditnota met wat vertraging kan komen maar automatisch verstuurd wordt.

  - **Programma's — Duidelijkere bevestiging bij "Plaatsingen bevestigen", "Programma annuleren" en "Sluiten"**: Deze drie knoppen bij een programma vroegen voorheen alleen een kort "weet je het zeker?" via de standaard browserpopup. Ze tonen nu een popup die uitlegt wat er precies gebeurt (welke mails er automatisch verstuurd worden, of er betaallinks/facturen of creditnota's aangemaakt worden, en dat bevestigen/annuleren niet terug te draaien is) voordat er definitief op "Programma Bevestigen", "Programma Annuleren" of "Programma Sluiten" geklikt wordt. Er verandert verder niets aan wat deze knoppen doen.

  - **Contacten — Nieuwe knop "Samenvoegen"**: Twee contacten die dezelfde persoon blijken te zijn, konden al samengevoegd worden door bij het ene contact het e-mailadres te wijzigen naar dat van het andere — dat gebeurde dan automatisch op de achtergrond. Daar staat nu een expliciete knop "Samenvoegen" voor bij elk contact, met een popup waarin een ander contact opgezocht kan worden (typen op naam of e-mailadres) om mee samen te voegen. Na bevestigen worden alle inschrijvingen, verkopen, facturen, e-maillogs, evaluaties, winkelmandjes, loyaliteitspassen, favorieten, kortingen, abonnementen en organisatiekoppelingen van dit contact verhuisd naar het gekozen contact, en wordt dit contact verwijderd. Persoonsgegevens (naam, adres, telefoon, geboortedatum e.d.) van het gekozen contact blijven leidend; alleen velden die daar nog leeg zijn worden aangevuld vanuit het verwijderde contact. Dezelfde, nu completere samenvoeglogica wordt ook gebruikt bij de bestaande "wijzig e-mailadres naar een bestaand contact"-route.

  - **Producten en Cursussen — Nieuw veld "Extra e-mailtekst"**: Bij Producten en Cursussen (tabblad "Algemeen") is een nieuw veld "Extra e-mailtekst" toegevoegd, vergelijkbaar met de bestaande velden "Extra Info" en "Materialen". Deze tekst is niet zichtbaar op de website, maar wordt straks (indien ingevuld) beschikbaar voor gebruik in e-mails. Bij Cursussen wordt de tekst, net als "Materialen", automatisch overgenomen zodra er een nieuw programma wordt aangemaakt, maar kan bij dat programma zelf nog los aangepast worden. Het veld is vooralsnog alleen toegevoegd aan de formulieren; de bestaande e-mailsjablonen tonen deze tekst nog niet automatisch.

  - **E-mailsjabloon "Overplaatsing cursist" — Oude en nieuwe programma los beschikbaar**: In het sjabloon voor de "Overplaatsing cursist"-mail (verstuurd bij het verplaatsen van een inschrijving naar een ander programma) kunnen nu ook `program_old` (het programma waar de cursist vandaan komt) en `program_new` (het nieuwe programma) los als variabelen gebruikt worden, naast de bestaande `program`-variabele (die verwijst naar het nieuwe programma).

  - **Directe betaalknop toegevoegd aan factuur-, herinnerings- en bedrijfsfactuurmails**: De factuurmail, de betalingsherinnering en de factuur naar een bedrijf konden al een betaalknop bevatten, maar die verwees op een aantal plekken naar een vaste, niet-werkende link, of ontbrak helemaal. Alle drie verwijzen nu naar een directe, werkende betaallink voor de betreffende factuur (bij een bedrijfsfactuur alleen wanneer die daadwerkelijk via bankoverschrijving loopt — anders wordt de knop weggelaten in plaats van een foutmelding te tonen).
  - **Betaallink cursusinschrijving en productverkoop samengevoegd tot één mail**: Er waren twee losse, apart instelbare mails voor het versturen van een betaallink — één specifiek voor een cursusinschrijving, één voor een productverkoop. Dit is nu één en dezelfde mail geworden die verwijst naar de factuur zelf in plaats van naar het specifieke item, zodat dezelfde tekst voor beide situaties werkt. De bestaande tekst voor de cursusinschrijving-variant blijft intact en wordt nu ook voor productverkopen gebruikt; het losse sjabloon dat eerder alleen voor productverkopen gold, is niet meer gekoppeld (staat nog wel in de geschiedenis).

  - **Statuslabels — "Laatste plekken" krijgt nu voorrang op "Laatste kans"**: Wanneer een startdatum tegelijk bijna vol zit (nog maar 2 plekken over) én binnen een week begint, werd voorheen altijd "Laatste kans" getoond. Voortaan weegt een bijna volle cursus zwaarder mee: in die situatie verschijnt nu "Laatste plekken" in plaats van "Laatste kans". Dit geldt zowel op cursus- als op programmaniveau, en bij alle thema's.

  - **Checkout — Opmerkingenveld verplaatst naar het laatste scherm vóór betalen**: Het opmerkingenveld stond tot nu toe alleen op het eerste scherm van de checkout (gegevens invullen). Bij Utrecht moet een bezoeker daarin bijvoorbeeld aangeven hoeveel korting die met de Stadspas wil gebruiken, maar dat scherm was op dat moment nog niet compleet, waardoor mensen terug moesten naar stap 1 om dit alsnog in te vullen. Het opmerkingenveld staat nu bij alle thema's op het laatste scherm vóór het afronden van de betaling — bij de meeste thema's is dat het overzichtsscherm, bij Gouda en Demo (die geen apart overzichtsscherm hebben) het deelnemersscherm met de betaalknop.

  - **Rapportages — Demografie toonde bij geslacht bijna altijd "Anders"**: In het demografie-rapport werd het geslacht van een cursist alleen herkend als de waarde in de database exact "Mw." of "Dhr." was. Andere schrijfwijzen die in de praktijk ook voorkomen (zoals "mevr." of "dhr.", met kleine letter) vielen daardoor stelselmatig onder "Anders". De herkenning is nu ongevoelig voor hoofd-/kleine letters en herkent ook een aantal andere gangbare varianten (o.a. "mevrouw", "vrouw", "heer", "man"), zodat het geslacht voortaan correct in het rapport verschijnt.

  - **Productverkopen — Sprong terug naar "Betaald" nadat ze al als "Verwerkt" waren gemarkeerd**: Wanneer een productverkoop (handmatig aangemaakt, of zakelijk op rekening besteld) al door het secretariaat op "Verwerkt" was gezet, en de bijbehorende betaling kwam daarna pas binnen (bijv. via een betaallink), dan zette de betalingsbevestiging van Mollie de status stilzwijgend terug naar "Betaald" — de "Verwerkt"-markering ging zo verloren. Een betalingsbevestiging die binnenkomt nadat een productverkoop al als "Verwerkt" gemarkeerd is, zet de status voortaan niet meer terug.

  - **Overzichten — Knop "Reset" zette ook de kolomkeuze terug**: Bij overzichten met de knop "Reset" (rechtsboven, naast het aantal resultaten) werden filters, zoekopdracht én de handmatig aan-/uitgevinkte kolommen ("Kolom zichtbaarheid") allemaal tegelijk teruggezet naar de standaardweergave. De knop "Reset" wist voortaan alleen nog filters, zoekopdracht en sortering; welke kolommen je zichtbaar hebt gezet, blijft daarbij onthouden.

  - **Herinneringsmail openstaande factuur — Werkte nog steeds niet bij productverkopen**: In een eerdere update (zie hieronder, week van 3 tot 9 augustus) is deze herinneringsmail al eens gerepareerd, maar bij facturen die horen bij een productverkoop (in plaats van een cursusinschrijving) bleef de herinnering alsnog mislukken, zonder dat dit ergens zichtbaar werd — geen foutmelding, geen logregel, gewoon stilzwijgend geen mail. Oorzaak was dat het sjabloon gegevens van de cursusinschrijving verwachtte (zoals de cursusnaam) die een productverkoop niet heeft. De herinnering wordt nu voor beide soorten facturen correct verstuurd, inclusief een directe betaallink naar de betreffende factuur en de bijbehorende factuur-PDF als bijlage; eventuele toekomstige verzendfouten worden voortaan ook echt gelogd, zodat ze niet meer onopgemerkt kunnen blijven. Dezelfde bescherming is ook toegepast op het versturen van de oorspronkelijke (gecombineerde) factuurmail, voor het geval die ooit in dezelfde situatie terechtkomt.

  - **Deelnemerslijst naar docent — Laatst geplaatste deelnemer ontbrak altijd**: Zodra bij een definitief programma een inschrijving op "geplaatst" werd gezet, kreeg de docent automatisch een e-mail met de bijgewerkte deelnemerslijst. Daarin ontbrak echter stelselmatig precies de deelnemer die op dat moment net geplaatst werd (en dus de mail veroorzaakte) — de lijst leek steeds één deelnemer achter te lopen. Oorzaak was dat de lijst werd opgebouwd vlak vóórdat die plaatsing zelf in de database werd opgeslagen. De laatst geplaatste deelnemer staat nu gewoon op de lijst.

  - **Evaluatie-uitnodigingen en -herinneringen — Konden bij mensen op de wachtlijst terechtkomen**: Evaluatieresponses worden aangemaakt op basis van de status op dát moment ("geplaatst"), maar het versturen van de uitnodiging en een eventuele herinnering gebeurt in een latere, aparte stap zonder die status opnieuw te checken. Werd een inschrijving in de tussentijd teruggezet naar "wachtlijst" (bijv. bij een handmatige correctie, of automatisch wanneer bleek dat een programma toch al vol zat), dan ging de evaluatie-uitnodiging (en eventueel de herinnering) alsnog naar die persoon, terwijl die nooit daadwerkelijk heeft deelgenomen. Vlak vóór het versturen wordt nu opnieuw gecontroleerd of iemand nog steeds als "geplaatst" geregistreerd staat; is dat niet meer zo, dan wordt de mail overgeslagen.

  - **Dagelijkse VUAdmin mail — Mollie ID bij productverkopen stond vaak op "Onbekend"**: In het overzicht van (gedeeltelijk) te crediteren facturen zoekt de mail bij een credit de bijbehorende oorspronkelijke Mollie-betaling op, om het Mollie ID te kunnen tonen. Die zoekopdracht vereiste dat het bedrag van de credit precies gelijk was aan het oorspronkelijke betaalde bedrag — bij een gedeeltelijke creditering (een deel van het bedrag terugbetalen) klopte dat nooit, waardoor het Mollie ID op "Onbekend" bleef staan. Dit trof zowel inschrijvingen als productverkopen, maar viel bij productverkopen vaker op omdat gedeeltelijke crediteringen daar vaker voorkomen. Wanneer er geen exacte match is, wordt nu teruggevallen op de meest recente betaalde Mollie-betaling van dezelfde inschrijving of productverkoop, zodat het Mollie ID voortaan ook bij gedeeltelijke crediteringen gewoon getoond wordt.

  - **Synchronisatie met Moodle — Mislukte cursisten en docenten werden bij elke run opnieuw geprobeerd**: Als het aanmaken van een cursist of docent in Moodle mislukte — bijvoorbeeld door een ongeldig e-mailadres, of omdat Moodle een account als "al bestaand" afwees zonder dat dit door onze koppeling herkend werd — werd exact dezelfde poging bij de volgende synchronisatie (elke 15 minuten) gewoon opnieuw gedaan, keer op keer, zonder dat dit ergens zichtbaar werd. Zo'n mislukte poging wordt voortaan na een paar keer niet meer automatisch herhaald; een tijdelijke storing (bijv. Moodle even niet bereikbaar) krijgt nog wel een aantal nieuwe kansen voordat ermee gestopt wordt.

  - **Programma en Les bewerken — Veld "Ruimte" kon stoppen met werken bij grotere programma's**: Bij het bewerken van een programma (of een losse les daarbinnen) kon het veld "Ruimte" bij het openen of zoeken plotseling niets meer laten zien, zonder duidelijke foutmelding op het scherm. Dit gebeurde vooral bij programma's met veel lesdagen en/of inschrijvingen. Oorzaak was dat bij elke aanvraag voor dit veld de volledige inhoud van het formulier (inclusief alle lesdagen en inschrijvingen) werd meegestuurd als onderdeel van de link naar de server; bij grotere programma's werd die link te lang en weigerde de server de aanvraag. Dit wordt voortaan op een andere manier verstuurd, zodat het veld "Ruimte" ook bij grote programma's blijft werken.

  - **Nieuwe e-mail voorbereid: bevestiging per productbestelling (nog niet actief)**: Bij een bestelling met inschrijvingen krijgt niet alleen de koper een totaalbevestiging, maar ook elke deelnemer apart een eigen bevestiging van zijn/haar inschrijving. Bij productbestellingen bestond dat tweede deel nog niet: alleen de koper kreeg een (totaal)bevestiging, en de deelnemer/begunstigde van een product — als dat iemand anders is dan de koper — kreeg zelf niets. Hiervoor is een nieuw event "Bevestiging productbestelling" toegevoegd, met een concept-sjabloon klaar in het beheer bij E-mailsjablonen (los van de bestaande mail "Product verwerkt", die pas later verstuurd wordt zodra het secretariaat een bestelling handmatig als verwerkt markeert). Het nieuwe event is nog niet gekoppeld aan een actief sjabloon, dus er wordt nog niets verstuurd — dat gebeurt pas zodra het sjabloon in het beheer aan het event gekoppeld en geactiveerd wordt.

  - **Lesdagen — Nieuw vinkje "Gefactureerd"**: Bij een lesdag kan nu aangevinkt worden of deze al gefactureerd is — zowel bij de lesdagen/rijen in het planningstabblad van een programma als bij een losse lesdag zelf. Het vinkje staat standaard uit en heeft voorlopig geen verdere werking; het is bedoeld om straks in rapportages te kunnen gebruiken.

  - **Lesdagen — Nieuw opmerkingenveld**: Bij een lesdag kan nu een korte opmerking (max. 255 tekens) worden ingevuld — bijvoorbeeld om aan te geven dat het om een excursiedag, toetsdag, vervangende les of vervangende docent gaat. Het veld staat, net als "Gefactureerd", zowel bij de lesdagen/rijen in het planningstabblad van een programma als bij een losse lesdag zelf, en wordt (indien ingevuld) ook getoond bij de betreffende lesdag op de cursuspagina.

  - **Checkout — Cart message van een product ontbrak nog op het allerlaatste scherm vóór betalen**: Bij een product kan een eigen "cart message" worden ingesteld, die op meerdere plekken in de checkout onder de producttitel wordt getoond. Op het laatste scherm vóór het betalen (het overzichtsscherm "Controleer je bestelling") stond in plaats daarvan nog het producttype. Bij alle thema's met dit aparte overzichtsscherm (Amsterdam, Breda, Demo, Utrecht, Vudemo, Westvoorne) staat hier voortaan ook de cart message onder de producttitel, in plaats van het producttype.

  - **Rapportages — Nieuw rapport "Sessies: Locatiefacturatie"**: Er is een nieuw rapport toegevoegd waarmee per gekozen periode (en optioneel gefilterd op één locatie) alle lesdagen (sessies) met hun locatiegegevens opgevraagd kunnen worden. Per sessie toont het rapport onder meer start- en eindtijd, duur in minuten, DCU, of de sessie als "Gefactureerd" is aangevinkt, het aantal geplaatste deelnemers, en van de locatie de ruimte, het uurtarief, het contracttype, adres en de contactpersoon — bedoeld om de facturatie richting locaties te ondersteunen. Te vinden bij Rapportages.

  - **Knopje "Open" bij gekoppelde gegevens vervangen door klein icoontje naast het label**: Het knopje om een gekoppeld item (bijv. de cursus of locatie bij een programma) in een nieuw tabblad te openen — eerder toegevoegd als los knopje "Open" onder het veld — stond daardoor op een eigen regel en oogde rommelig. Dit knopje is vervangen door een klein, subtiel icoontje direct naast het label van het veld zelf (bijv. naast "Cursus"). De werking is ongewijzigd: is er nog niets gekoppeld, dan verschijnt er nog steeds geen icoontje.

  - **Overzichten — Actieknoppen per rij opgeruimd onder één knop "Acties"**: Bij overzichten (Cursussen, Programma's, Facturen, Cursisten, enz.) stonden achter elke regel alle knoppen los naast elkaar — Verwijderen, Logs, en waar van toepassing extra knoppen zoals "Annuleren", "Uitnodigen" of "Factuur" — wat bij meerdere knoppen al snel rommelig oogde. Alleen de knop "Bewerken" staat voortaan nog los zichtbaar; alle overige knoppen van die rij zijn samengevoegd onder één knop "Acties" die bij een klik uitklapt. Er is geen enkele knop of actie verdwenen, verwijderen en de overige acties werken op dezelfde manier als voorheen — ze staan alleen niet meer allemaal los naast elkaar. In het uitklapmenu heeft elke actie voortaan zowel een icoontje als een tekstlabel (voorheen had bijvoorbeeld "Verwijderen" alleen een prullenbak-icoontje, en had het annuleren van een programma alleen een kruisje/vinkje zonder duidelijke tekst), staan alle regels even hoog en is de tekst iets dikker gedrukt voor betere leesbaarheid. De knop "Activity" (activiteitenlog) heet daar voortaan ook gewoon "Activiteit" in plaats van het Engelse "Activity".

  - **Overzichten — Een aantal losse knoppen verplaatst naar "Acties", en een paar nieuwe acties toegevoegd**: Bij een aantal overzichten stond nog een actie in een aparte kolom in plaats van bij de andere acties; die zijn nu ook verplaatst naar het "Acties"-menu: bij Productverkopen de knop "Verwerkt"/"Niet verwerkt" (de status was daarnaast toch al gewoon zichtbaar in een eigen kolom), en bij Facturen de knoppen "Download factuur" en "Herdruk PDF". Bij Cursisten ("Contacten") heette de knop om iemand te anonimiseren voorheen gewoon "Verwijderen" (met een verwijder-melding, terwijl er in werkelijkheid niets verwijderd wordt); deze heet nu duidelijk "Anonimiseren". Nieuw is de actie "Sluiten" bij Programma's, die de datum "inschrijving gesloten" direct op vandaag zet. Ook nieuw: een "Preview"-knop die de bijbehorende pagina in een nieuw tabblad opent, toegevoegd bij Webpagina's, Collecties, Cursussen, Blog artikelen, Docenten en Producten — bij Blog artikelen, Docenten en Producten bestond deze preview nog niet, en toont deze knop (net als bij Webpagina's al het geval was) ook een nog niet gepubliceerd/actief item, zodat je het kan bekijken voordat het live gaat.

  - **Webpagina's — Nieuwe filters: SEO compleet, Type en Actief**: Het overzicht van webpagina's kan nu gefilterd worden op of de SEO-velden (titel en omschrijving) compleet zijn ingevuld ("Ja"/"Nee"), op het paginatype, en op of een pagina actief (online) staat.

  - **FAQ's — Nieuw veld "Actief", nieuwe kolom en filters op categorie en actief**: Bij een FAQ kan nu met een schakelaar aangegeven worden of deze actief is (standaard aan bij een nieuwe FAQ); dit is ook zichtbaar als kolom in het overzicht. Het overzicht kan daarnaast gefilterd worden op categorie en op actief/niet actief.

  - **Blog artikelen — Nieuwe filters: Status en Publicatiedatum, plus kolom en filter "SEO compleet"**: Het overzicht van blogartikelen kan nu gefilterd worden op status (Concept/Gepubliceerd/Ingepland) en op publicatiedatum (periode van/tot). Net als bij Webpagina's is er nu ook een kolom en filter "SEO compleet" die aangeeft of de SEO-titel en -omschrijving van een artikel zijn ingevuld.

  - **Organisaties — Nieuw tabblad "Facturen" en kolom "Gem. betaaldagen"**: Bij een organisatie is een nieuw tabblad "Facturen" toegevoegd met alle facturen van die organisatie, inclusief de betaalstatus per factuur (Betaald, Openstaand, Herinnerd, Achterstallig of Ingepland) en, zodra een factuur betaald is, het aantal dagen dat het duurde voordat deze betaald werd. In het organisatie-overzicht zelf is daarnaast een nieuwe kolom "Gem. betaaldagen" toegevoegd, met het gemiddeld aantal dagen dat het bij die organisatie duurt voordat een factuur betaald wordt.

  - **Organisaties — Nieuwe filters: Openstaande facturen en Laatste order datum**: Het organisatie-overzicht kan nu gefilterd worden op of een organisatie openstaande (nog niet betaalde) facturen heeft ("Ja"/"Nee"), en op de datum van de laatst geplaatste order (periode van/tot).

  - **Locaties — Nieuw filter "Type", nieuwe kolommen contactpersoon, en koppeling met Organisatie**: Het overzicht van locaties kan nu gefilterd worden op type, en toont voortaan ook het e-mailadres en telefoonnummer van de contactpersoon als eigen kolommen (deze gegevens konden al ingevuld worden, maar waren nog niet zichtbaar in het overzicht zelf). Daarnaast kan een locatie nu (niet verplicht) gekoppeld worden aan een organisatie, op het tabblad "Algemeen" — bedoeld om vast te leggen naar welke organisatie facturen voor die locatie moeten, bijvoorbeeld bij een extern gehuurde locatie.

  - **Docenten — Koppeling met Organisatie**: Een docent kan nu, net als een locatie, (niet verplicht) gekoppeld worden aan een organisatie, op het tabblad "Algemeen" — bijvoorbeeld handig wanneer een docent namens een bedrijf factureert. Heeft een docent geen eigen KVK-, BTW- of IBAN-nummer ingevuld maar wel een organisatie gekoppeld, dan wordt voortaan (waar deze gegevens gebruikt worden, bijv. in facturen of exports) automatisch teruggevallen op de gegevens van de gekoppelde organisatie. Het bewerkscherm van de docent zelf en het profiel in het docentenportaal blijven altijd het eigen (eventueel lege) veld tonen.

  - **Docenten — Wordt nu ook automatisch als contact aangemaakt**: Bij het aanmaken van een nieuwe docent wordt voortaan gecontroleerd of er al een contact (cursist) bestaat met hetzelfde e-mailadres. Bestaat dat nog niet, dan wordt automatisch een nieuw contact aangemaakt met de naam en het e-mailadres van de docent, zodat een docent ook als contact terug te vinden is.

  - **Facturen — Bewerkscherm overzichtelijker, met betaalstatus bovenaan en meer directe links**: Bovenaan het bewerkscherm van een factuur staat nu eerst een compact blok "Factuurgegevens" met factuurnummer, factuurdatum en vervaldatum, met de betaalstatus (bijv. "Betaald", "Openstaand", "Herinnerd") als label rechtsboven in beeld — de losse velden hiervoor (incl. het totaalbedrag, dat toch al bij de factuurregels te zien is) zijn hiermee vervallen. "Betaalmethode" en "Betaaldatum" staan voortaan onder het factuuroverzicht, onder de kop "Betaling registreren". Achter het factuurnummer staat nu een downloadlinkje naar de PDF (indien beschikbaar), en achter de ontvanger, de deelnemer, en (bij een productverkoop) de gekoppelde productverkoop staat hetzelfde kleine linkicoontje dat ook elders in het beheer wordt gebruikt om direct naar het gekoppelde item te springen. De losse links "Adresgegevens bewerken (deelnemer)" en "PDF herdrukken" zijn hiermee vervallen — herdrukken kan nog gewoon via de knop in het overzicht.

  - **Programma's — Statuskolom als kleurenpil, en nieuw filter "Status"**: De statuskolom bij programma's toont voortaan een kleurenpil (Gepland, Open, Gestart, Bevestigd, Wachtlijst, Gesloten of Geannuleerd) in plaats van platte tekst. Het programma-overzicht kan nu ook op deze status gefilterd worden.

  ### 🐛 Bugfixes

  - **Checkout — Kortingscode of Stadspasnummer met spaties werd afgekeurd**: Op het scherm met de deelnemersgegevens (waar ook de kortingscode of het Stadspasnummer ingevuld kan worden) werd een code met spaties erin — bijvoorbeeld doordat het lange Stadspasnummer in groepjes getypt of geplakt wordt — niet herkend, ook al was de code op zichzelf geldig. Alleen spaties aan het begin en einde werden weggehaald; spaties middenin de code niet. Bij het controleren en toepassen van de code worden voortaan alle spaties verwijderd, niet alleen die aan de randen. Dit geldt bij alle thema's met dit veld (Amsterdam, Breda, Utrecht, Vudemo, Westvoorne). Bij Westvoorne bleek de code daarnaast om een andere reden altijd te worden afgekeurd — de melding "code niet geldig" verscheen daar tot nu toe bij iedere code, ook een correcte; dit is nu ook verholpen.

  - **Organisaties — Bewerkscherm kon erg traag laden, medewerkerslijst overzichtelijker gemaakt**: Bij het openen van een organisatie in het beheer kon het bewerkscherm lang blijven laden. Oorzaak was een configuratiefout waardoor er bij het koppelen van een medewerker niet, zoals bedoeld, gezocht kon worden op naam, maar in plaats daarvan de volledige lijst van alle cursisten in één keer werd ingeladen. Naast deze snelheidsfix is de lijst zelf ook simpeler geworden: gekoppelde medewerkers staan nu in een overzichtelijke lijst met alleen een prullenbak-icoontje om iemand te ontkoppelen, en daaronder één zoekveld (met rol-keuze) om iemand nieuw te koppelen. Toevoegen en verwijderen gebeurt direct, zonder dat de pagina herlaadt, zodat eventuele nog niet opgeslagen wijzigingen elders op het scherm niet verloren gaan.

  - **Organisaties — Werd al aangemaakt bij het invullen van bedrijfsgegevens, in plaats van pas bij het afronden van de bestelling**: Zodra bij stap 1 van het bestelproces bedrijfsgegevens werden ingevuld, werd meteen een organisatie aangemaakt (of eraan gekoppeld), ook als de bestelling daarna nooit werd afgerond. Startte iemand later alsnog een nieuwe, wél afgeronde bestelling met dezelfde bedrijfsgegevens, dan kon datzelfde bedrijf daardoor dubbel in de organisatielijst terechtkomen. Een organisatie wordt nu pas aangemaakt (of gekoppeld) op het moment dat de bestelling daadwerkelijk wordt afgerond.

  - **Organisaties — Productontvangers werden nog niet gekoppeld aan de organisatie**: Bij een zakelijke bestelling werden de besteller (contactpersoon) en de deelnemers aan een cursus al automatisch gekoppeld aan de organisatie, maar de ontvanger van een besteld product (als dat iemand anders is dan de besteller) nog niet. Dit gebeurt nu, net als bij de contactpersoon en de cursusdeelnemers, ook automatisch voor productontvangers.

  - **Factuur-PDF — Bij een productregel stond na "Deelnemer:" de naam van de besteller in plaats van de ontvanger**: Op de factuur wordt onder een productregel, indien bekend, de naam getoond van degene voor wie het product bedoeld is. Bij een product stond hier echter altijd de naam van de besteller (koper), ook wanneer bij de bestelling een andere ontvanger was opgegeven — een product heeft immers geen "deelnemer" zoals een cursus dat wel heeft. Op de factuur staat hier voortaan de daadwerkelijke ontvanger van het product; is er geen aparte ontvanger opgegeven, dan blijft de besteller zichtbaar zoals voorheen.

  - **E-maillog — Interne melding "Opmerking bij order" stond er niet in**: Wanneer bij een bestelling een opmerking wordt ingevuld, gaat daar automatisch een interne mail over naar het secretariaat — net als bijvoorbeeld de dagelijkse VUAdmin-mail werd deze echter niet weggeschreven naar het e-maillog, waardoor niet na te zoeken was of en wanneer die verstuurd is. Deze mail wordt nu, net als de dagelijkse VUAdmin-mail, ook in het e-maillog gelogd.

  - **Dashboard — Nieuw blok "Mededelingen" vanuit Malo Media**: Bovenaan het dashboard verschijnt voortaan, indien van toepassing, een blok "📢 Mededelingen" met berichten die vanuit het beheer van Malo Media naar deze VU worden gestuurd — bijvoorbeeld om te laten weten wat er nieuw is in een release, of om te waarschuwen voor gepland onderhoud. Een mededeling krijgt, afhankelijk van het type, een gekleurd label ("Nieuw", "Belangrijk" of "Onderhoud") en kan een datum en een link "Meer lezen" bevatten. Malo Media kan een mededeling ook op een later moment nog aanpassen of weer intrekken; dit werkt automatisch door naar het dashboard, zonder dat daar iets voor gedaan hoeft te worden.

  - **Dashboard — Mededelingen zijn nu in te klappen en per gebruiker te sluiten**: Het blok "📢 Mededelingen" hierboven toont meerdere mededelingen nu als een uitklapbare lijst: titel, type en datum blijven zichtbaar, de inhoud klapt open bij een klik erop. Elke mededeling heeft daarnaast een sluitknop (×) — na sluiten verschijnt die specifieke mededeling niet meer terug op het dashboard van die gebruiker; andere gebruikers blijven hem gewoon zien totdat zij hem zelf ook sluiten.

  - **Programma's — Status in overzicht nu als gekleurd label**: In het overzicht van programma's stond de status (open, gesloten, wachtlijst enz.) alleen als platte tekst, en was niet in één oogopslag te zien in welke fase een programma precies zat (bijv. wel al bevestigd, of al gestart). De status verschijnt daar nu als gekleurd label — Gepland, Open, Gestart, Bevestigd, Wachtlijst, Gesloten of Geannuleerd — met een eigen kleur per fase, en is ook te filteren op deze status. Wat de status betekent en hoe die berekend wordt, is niet veranderd; alleen hoe die getoond wordt.

  - **Programma's — Inschrijvingen-kolom toont nu ook het minimum, en is kleurgecodeerd**: De kolom "Inschrijvingen" bij een programma toonde het aantal geplaatste deelnemers ten opzichte van het maximum (bijv. "12/15"); het ingestelde minimum was daarbij nergens te zien. Deze kolom toont voortaan "geplaatst / minimum-maximum" (bijv. "12 / 10-15") en krijgt een kleur op basis van hoe dat aantal zich verhoudt tot het minimum en maximum: oranje (nog onder het minimum), blauw (minimum behaald), groen (maximum behaald, vol) of rood (over het maximum geboekt). Wachtlijst, intake en controle staan er als aparte gekleurde tellers naast (respectievelijk oranje, paars en rood; voorheen stonden intake en controle samengeteld achter één kleur). Dezelfde weergave staat ook op het bewerkscherm van een programma, en wordt nu altijd live berekend in plaats van periodiek (elk uur) bijgewerkt — een wijziging in inschrijvingen of in het minimum/maximum is dus meteen zichtbaar.

  - **Nieuw: Meldingenbel in VUAdmin, met optionele browsermeldingen**: Naast het accountpictogram staat voortaan een belletje met een teller voor ongelezen meldingen. Je krijgt daar direct een melding bij: je eigen rapport dat klaar is, een nieuwe inschrijving die in "controle" komt, een mislukte e-mail, de laatste plek die verkocht is bij een programma, een programma dat zijn minimum aantal inschrijvingen bereikt, een kortingspas-gebruik dat op goedkeuring wacht, en een vrije dag die een docent doorgeeft. Via het belletje-icoon kunnen browsermeldingen aangezet worden, zodat deze meldingen ook binnenkomen wanneer VUAdmin niet open staat (na eenmalig toestemming geven in de browser). De bestaande meldingenlijst op het dashboard (bijv. programma's zonder locatie, te lang openstaande facturen) blijft ongewijzigd bestaan naast de nieuwe bel.

  - **⚡ Website (met name thema Breda) — Trage laadtijd homepage verholpen**: De site-instellingen (sitenaam, top-scripts, mededelingenbalk e.d.) werden bij elk los onderdeel van een pagina steeds opnieuw en ongecachet uit de database opgehaald. Op de homepage van Breda, met tientallen aparte cursuskaarten, slides en blokken, gebeurde dit daardoor tientallen keren per bezoek in plaats van één keer. Deze site-instellingen worden nu één keer per uur gecachet in plaats van bij elk paginaonderdeel opnieuw opgehaald. Ook twee andere onderdelen van de Breda-homepage — de "populair en trending"-carrousel en de tekst/afbeelding-blokken van de pagina — werden bij elk bezoek ongecachet opnieuw opgehaald, in tegenstelling tot de rest van de homepage; deze zijn nu op dezelfde manier gecachet. Dit verbetert vooral de laadtijd van de Breda-homepage merkbaar.

  ### 🎨 Thema-updates Amsterdam

  - **Toegankelijkheid — Iconen in de header en de inschrijfknop bij de nieuwsbrief hadden geen label voor schermlezers**: Het hartje ("Favorieten"), het accountpictogram en het winkelmandje in de header, en de inschrijfknop bij de nieuwsbrief in de footer, bestonden alleen uit een icoontje (bij de nieuwsbriefknop op mobiel zelfs alleen een pijltje) zonder herkenbare tekst voor een schermlezer. Deze hebben nu allemaal een duidelijk label gekregen ("Favorieten", "Inloggen"/"Mijn account", "Winkelmand", "Inschrijven").

  - **Toegankelijkheid — "Home" in de broodkruimel op mobiel niet herkenbaar voor schermlezers**: Op de meeste pagina's toont de eerste broodkruimel ("Home") op mobiel alleen een huisje-icoontje; de tekst "Home" zelf is dan verborgen. Voor een schermlezer bleef er zo geen herkenbare naam over. Deze link heeft nu ook op mobiel een label ("Home").

  - **Toegankelijkheid — Pagina's hadden geen "hoofdinhoud"-landmark**: Schermlezers gebruiken landmarks (zoals "hoofdinhoud") om snel door een pagina te navigeren; die landmark ontbrak op alle pagina's van dit thema. De hoofdinhoud van elke pagina is nu als zodanig gemarkeerd, zonder dat dit iets aan de vormgeving verandert.

  - **Mobiel menu — Onderliggende menu-items (bijv. onder "Over ons") kregen meer ruimte**: De links in een uitklapbaar submenu van het mobiele hoofdmenu stonden met wat ruimte ertussen, maar waren zelf nauwelijks aan te raken (een paar pixels hoog) — lastig op een klein scherm. Deze links zijn nu zelf groter aanraakbaar gemaakt, in plaats van dat de ruimte ernaast onaanraakbaar bleef.

  - **Laadprestaties — jQuery UI-bestanden waren onnodig groot**: De JavaScript- en CSS-bestanden van jQuery UI (o.a. gebruikt voor de datepicker) stonden nog als onverkleinde ("unminified") ontwikkelversie op de website, samen goed voor ruim een halve MB. Dit zijn nu de officiële, geminificeerde bestanden van dezelfde versie, met exact dezelfde functionaliteit maar een stuk kleiner (het JS-bestand ging van ruim 500KB naar ongeveer 250KB).

  ## Week van 10 tot 16 augustus 2026

  ### ✨ Nieuw & Verbeterd

  - **Facturen — Factuurregels direct zichtbaar bij het bewerken van een factuur**: Bij het openen van een factuur in het beheer was nog niet in één oogopslag te zien waar de factuur precies over gaat, zonder de PDF te openen. Onder de factuurgegevens staat nu een overzicht van de factuurregel(s) — omschrijving, prijs excl. BTW, BTW en totaal — hetzelfde overzicht dat ook op de PDF te zien is.

  ### 🐛 Bugfixes

  - **Overzichten — Aan-/uitzetten van kolommen ("Kolom zichtbaarheid") werd niet meer opgeslagen**: Bij overzichten met de knop "Kolom zichtbaarheid" (bijv. Webpagina's, Cursussen, Producten, Facturen) leek het aan- of uitvinken van een kolom in de tabel zelf meteen te werken, maar de keuze werd niet meer opgeslagen: na het herladen van de pagina of op een ander apparaat stond alles weer op de standaardweergave. Oorzaak was dat een eigen aanpassingsbestand (JavaScript) door een configuratiefout stilzwigend niet meer werd ingeladen, zonder zichtbare foutmelding. Dit is verholpen: de kolomkeuze per gebruiker en per overzicht wordt weer correct opgeslagen en automatisch toegepast zodra dat overzicht opnieuw geopend wordt.

  - **Beheer — Eigen stijlaanpassingen (CSS) werden soms niet geladen**: Om dezelfde reden als hierboven werden ook eigen stijlaanpassingen in het beheer soms niet correct ingeladen. Zo staan de items onder een uitklapbare menurubriek (bijv. "Instellingen", "Logs") nu weer duidelijk ingesprongen ten opzichte van de hoofditems.

  - **Bestelproces — Kortingscode ging altijd op "controle" te staan, ook als dat niet nodig was**: Bij een korting (kortingscode of kortingspas) kan per korting ingesteld worden of een inschrijving eerst handmatig gecontroleerd/goedgekeurd moet worden voordat deze definitief is ("Controle" aan/uit). Bij het afronden van een bestelling met directe betaling werd een inschrijving met een kortingscode echter altijd op "controle" gezet, ook wanneer die instelling bij de betreffende korting uitstond. Alleen bij kortingspassen (loyaltyCards) werd al wel correct naar deze instelling gekeken. Dit is verholpen: een inschrijving met kortingscode gaat voortaan alleen nog op "controle" staan wanneer dat bij de gebruikte korting ook daadwerkelijk is aangevinkt.

  ## Week van 3 tot 9 augustus 2026

  ### ✨ Nieuw & Verbeterd

  - **Cursusoverzicht (`/cursussen`) — Direct laden met "infinite scroll" (Amsterdam, Utrecht, Breda, Westvoorne, Vudemo)**: Naast de eerdere snelheidsverbetering van deze pagina (zie bugfixes) toont het cursusoverzicht nu, net als de aanbevolen-cursussen-blokken elders op de site, meteen de eerste cursussen en laadt de rest pas wanneer je naar beneden scrolt — in plaats van in één keer alle (soms honderden) resultaten tegelijk te laden en op te bouwen. Terwijl een volgende reeks cursussen op de achtergrond wordt opgehaald, verschijnen er kort een paar "skeleton"-kaartjes (een lichte knipperende placeholder) op de plek waar de nieuwe kaartjes zo verschijnen. Filteren, sorteren en zoeken werken op precies dezelfde manier als voorheen; alleen het laden van de resultaten zelf is nu getrapt in plaats van alles-in-één-keer.

  - **Locaties — Contract type toegevoegd**: Bij een locatie kan nu, net als bij een docent, een "Contract type" geselecteerd worden (bijv. per les, per deelnemer, vaste jaarbegroting), voor locaties met verschillende soorten afspraken (zoals in Breda en Amsterdam). De beschikbare contracttypes worden, net als bij Docent Contract, beheerd via het scherm "Types" (entiteit "Locatie Contract").

  - **Activity Log — Wijzigingshistorie op belangrijke onderdelen**: Bij Cursisten, Programma's, Cursussen, Webpagina's, Facturen, Inschrijvingen, Bestellingen, Kortingen, Betaalmethodes, E-mailsjablonen, Events en Gebruikers is nu een activiteitenlogboek beschikbaar: wie heeft wat gewijzigd, en wanneer. Bij elk overzicht en bij elke losse pagina staat een knop "Logs" die de wijzigingshistorie van dat item toont (oude en nieuwe waarde per veld), en er is een centraal overzicht "Activity Log" in het menu met alle activiteit door elkaar, doorzoekbaar en filterbaar. Alleen zichtbaar voor medewerkers met het nieuwe recht "Activity Log". Oudere logregels worden automatisch opgeruimd na een bewaartermijn die per onderdeel verschilt (financiële/audit-gevoelige gegevens zoals facturen en bestellingen 3 jaar, gebruikersaccounts 2 jaar, overige onderdelen 6 maanden tot een jaar).
  ...
  - **Lesdagen — Locatie en ruimte nu per lesdag aanpasbaar**: Bij het programma wordt de locatie en ruimte nog steeds ingesteld en gebruikt als standaardwaarde voor alle lesdagen, maar losse lesdagen kunnen nu ook een eigen locatie en ruimte krijgen, handig als één bijeenkomst van een cursus in een andere ruimte of op een andere locatie plaatsvindt. Bij het kiezen van een locatie toont het ruimte-veld automatisch alleen de ruimtes van die locatie, zowel bij het programma zelf als bij de losse lesdagen in het planningstabblad.

  - **Nieuw: Organisaties als apart onderdeel, gekoppeld aan cursisten**: Bedrijfsgegevens bij een zakelijke bestelling (bedrijfsnaam, BTW-nummer, adres, e-mail, etc.) werden tot nu toe telkens opnieuw als losse tekst bij elke bestelling ingevoerd, zonder enig verband tussen bestellingen van dezelfde organisatie. Er is nu een echt "Organisaties"-onderdeel (nieuw menu-item, zichtbaar met het recht "Organisaties") waarin een organisatie eenmalig wordt vastgelegd — inclusief een aantal nieuwe velden die er nog niet waren, zoals KVK-nummer, telefoonnummer, website en IBAN — en waaraan cursisten gekoppeld kunnen worden met een rol (Eigenaar, Directeur, Contactpersoon, Facturatiecontact of Medewerker). Bij het cursistenprofiel is een tabblad "Organisaties" toegevoegd dat toont bij welke organisaties iemand hoort. Vult iemand bij het bestelproces bedrijfsgegevens in, dan wordt automatisch de juiste organisatie gevonden (of aangemaakt) en gekoppeld aan zowel diegene die de bestelling plaatst als alle deelnemers die op die bestelling worden ingeschreven — niet alleen de besteller — zodat een volgende bestelling straks makkelijker te herleiden is tot dezelfde organisatie. Op de bestelling en de factuur verandert er niets: de bedrijfsgegevens worden nog steeds vastgelegd op het moment van bestellen, zodat een factuur altijd de gegevens toont zoals ze waren tíjdens de aankoop, ook als het organisatieprofiel daarna wijzigt.

  - **Menu opnieuw ingedeeld: nieuwe rubriek "CRM" en gebundelde "Logs"**: Cursisten, Organisaties, Docenten en Locaties stonden verspreid over "Administratie" en "Cursusbeheer" en staan nu samen onder een nieuwe rubriek "CRM" bovenaan het menu; het cursisten-onderdeel heet daar voortaan "Contacten" (alleen de menunaam en paginatitels zijn aangepast, verder is er niets veranderd aan cursisten zelf). Daarnaast zijn Email-logs, Foutmeldingen-logs, Activiteiten-logs ("Audit trail") en de externe Changelog-pagina, die eerder als aparte, losse menu-items stonden, nu gebundeld onder één uitklapbare rubriek "Logs".

  - **Bewerkschermen: consistentere tabbladen en overal echte iconen in plaats van emoji**: Bij bestellingen, inschrijvingen, producten, cursisten en meer werden tabbladen soms met een emoji vooraan aangeduid (bijv. "💵 Facturen") — dit is overal vervangen door een echt icoon uit dezelfde iconenset als de rest van het menu. Daarnaast zijn een aantal inconsistenties in tabbladen rechtgetrokken: "Basis" (productverkoop) heet nu overal "Algemeen", het dubbele "Algemeen"/"Persoonsgegevens" bij docenten is samengevoegd tot één tabblad, contractvelden die per ongeluk onder "Financieel" stonden staan nu bij "Contract", het tabblad "Marketing" staat nu overal direct na "Algemeen" in plaats van soms vooraan en soms achteraan, en bij programma's zijn "Groepsbericht" en "Correspondentie" (die allebei over e-mail naar cursisten gingen) samengevoegd tot één tabblad "Correspondentie", zoals dat ook al bij cursisten werkte.

  - **Nieuw: sneller doorklikken tussen gekoppelde gegevens**: Op meerdere plekken in het beheer stond een cursist, cursus, programma of factuur alleen als naam of in een keuzelijst, zonder mogelijkheid om er direct naartoe te springen. Bij bestellingen, productverkopen en programma's staat nu naast zo'n veld (bijv. de cursist bij een bestelling, of de cursus/locatie bij een programma) een klein potloodje waarmee dat gekoppelde item in een nieuw tabblad geopend wordt; bij facturenrijen (in bestellingen, inschrijvingen en productverkopen) kan de bijbehorende factuur nu ook direct geopend worden. Is er nog niets gekoppeld (bijv. bij een nieuwe, nog niet opgeslagen rij), dan verschijnt er simpelweg geen knopje — niets om op te klikken, geen foutmelding. Verder hebben Cursussen, Locaties en Docenten nu elk een tabblad "Programma's" met een overzicht van de bijbehorende programma's, en heeft een Organisatie een tabblad "Bestellingen" met alle bestellingen die namens die organisatie geplaatst zijn — dat gaf voorheen nergens een overzicht.

  ### 🐛 Bugfixes

  - **Mollie-webhook — Onnodige database-schrijfactie bij dubbele/herhaalde betaalmelding**: Mollie kan voor dezelfde betaling meerdere keren een webhook-melding versturen (bijv. bij een trage serverreactie). De beveiliging tegen het aanmaken van een dubbele factuur werkte al goed, maar de daaropvolgende herberekening van het betaalde bedrag en de status werd bij zo'n herhaalde melding nog steeds altijd opgeslagen, ook als er niets wijzigde. Dit wordt nu overgeslagen wanneer er niets is veranderd.

  - **Achtergrondtaken — Onnodige database-schrijfacties verwijderd**: De uurlijkse opschoontaak sloeg tot nu toe elk programma (tot twee keer) en elke cursus op, zelfs als er niets aan gewijzigd was; de taak die elke 4 minuten ontbrekende gegevens aanvult deed hetzelfde voor bepaalde inschrijvingen die telkens opnieuw dezelfde waarde herberekenden. Beide taken slaan nu alleen nog daadwerkelijke wijzigingen op, wat overbodige databaseacties en (met de nieuwe Activity Log, zie hierboven) overbodige logregels voorkomt. Bestaande logregels die enkel een tijdstip-wijziging bevatten zonder echte inhoudelijke wijziging zijn met een eenmalige opschoonactie verwijderd.

  - **Cursusoverzicht (`/cursussen`) — Aanzienlijk sneller laden**: De cursusoverzichtspagina was traag omdat voor elk getoond cursuskaartje het bijbehorende marketinglabel (bijv. "Laatste kans" of "Laatste plekken") werd berekend met een aparte, live databasevraag per programma — bij een pagina met veel cursussen en programma's liepen dit al snel op tot honderden extra databasevragen bij elke paginaweergave. Deze gegevens worden nu in één keer meegeladen bij het ophalen van de cursussen in plaats van per kaartje apart opgevraagd, en de basislijst met cursussen wordt bovendien kort (5 minuten) gecached, net als al gebeurde bij de homepage. Dit levert geen enkele zichtbare wijziging op, alleen een veel snellere pagina.
  ...
  - **Cijfer-overzicht op cursuspagina (Utrecht) — Sprak ten onrechte over "Onze cursussen"**: Het cijfer-overzicht in het evaluatieblok van een individuele cursuspagina gebruikte dezelfde tekst als op de homepage ("Onze cursussen worden gemiddeld beoordeeld met..."), ook al ging het daar om de score van die ene cursus. Op de cursuspagina staat nu de naam van de betreffende cursus in plaats van "Onze cursussen".
  ...
  - **Oude abonnementenmodule volledig verwijderd**: Ledenkortingen lopen tegenwoordig via producten (een korting gekoppeld aan een product) in plaats van via het oude, apart beheerde abonnementensysteem. Het bijbehorende model, het (allang niet meer gekoppelde) beheerscherm en -recht, de lidmaatschapsnummer-weergave op het cursistendashboard (Westvoorne) en de automatische ledenprijs-aanpassing in de nachtelijke opschoontaak zijn verwijderd. De database-tabellen van het oude systeem blijven ongewijzigd bestaan.
  ...
  - **Facturen — Zichtbaar wanneer een factuur verrekend is door een creditfactuur**: Bij een factuur die (deels) tegenover een creditfactuur op dezelfde inschrijving of productverkoop staat, is dit nu direct te zien. Het factuuroverzicht toont een badge "Verrekend" of "Deels verrekend", en op de factuur zelf staat een melding plus een overzicht van de gekoppelde factu(u)r(en) waarmee is verrekend.
  ...
  - **Dagelijkse VUAdmin-mail — Ontvangers en meldingen instelbaar**: Bij Beheer → Instellingen is een nieuw tabblad "Adminmail" toegevoegd. Hier stel je een kommagescheiden lijst van e-mailadressen in die de dagelijkse VUAdmin-mail ontvangen (voorheen ging deze altijd naar het ene ingestelde site e-mailadres), en kun je per type melding aan- of uitvinken of deze wordt meegenomen in de mail. Daarnaast is een nieuwe melding toegevoegd: programma's die het minimum aantal deelnemers hebben bereikt maar nog niet definitief zijn gemaakt, zodat dit niet over het hoofd wordt gezien.

  - **Programmaoverzicht — Filter op cursustype**: Naast het bestaande filter op locatie is het programmaoverzicht nu ook te filteren op cursustype.

  ### 🐛 Bugfixes

  - **Terugbetalingen en chargebacks via Mollie werden soms niet verwerkt**: Wanneer Mollie een terugbetaling meldde die niet precies overeenkwam met een vooraf klaarstaande creditfactuur — bijvoorbeeld een gedeeltelijke terugbetaling, een terugbetaling op een bestelling met meerdere items, of een chargeback (een terugboeking die de bank van de cursist zelf initieert) — werd dit door Mollie wel bevestigd, maar nergens in de administratie vastgelegd: geen creditfactuur, geen bijgewerkt betaald bedrag. Terugbetalingen én chargebacks worden nu altijd verwerkt en automatisch aan de juiste inschrijving of productverkoop gekoppeld. Kan er echt geen passend item gevonden worden, dan wordt de creditfactuur nog steeds aangemaakt (met bedrag en datum), maar dan niet gekoppeld — zodat een medewerker deze later handmatig kan koppelen in plaats van dat de terugbetaling spoorloos verdwijnt. Terugbetalingen van de afgelopen maanden die hierdoor eerder gemist zijn, zijn met terugwerkende kracht gecontroleerd en verwerkt, en dubbele creditfacturen die door de oude verwerking waren ontstaan zijn opgeschoond.

  - **Annuleren en korting geven pastte soms al verstuurde facturen aan**: Bij het annuleren van een inschrijving, of het achteraf toekennen van een korting, werd het bedrag op een reeds verstuurde factuur soms rechtstreeks aangepast (of op nul gezet) in plaats van er een aparte creditfactuur tegenover te zetten. Een verstuurde factuur wordt nu nooit meer gewijzigd; annuleringen en kortingen worden altijd verwerkt via een nieuwe creditfactuur, zodat het factuuroverzicht een correcte, onveranderde historie blijft tonen.

  - **Deelbetalingen — Vervolgtermijnen ontbraken soms**: Bij oudere inschrijvingen met een deelbetaling (bijvoorbeeld in 2 of 4 termijnen) werd soms alleen de eerste termijn als factuur aangemaakt, waardoor de resterende termijnen nooit werden verstuurd of betaald. Ontbrekende termijnen zijn met terugwerkende kracht aangevuld, en het handmatig aanmaken van een inschrijving met een deelbetaling in het beheerpaneel maakt voortaan altijd meteen alle termijnen aan.

  - **Dagelijkse VUAdmin-mail uitgebreid en verbeterd**: De mail meldt nu ook openstaande terugbetalingen op productverkopen (deze werden eerder gemist) en terugbetalingen die niet automatisch aan een inschrijving gekoppeld konden worden, plus kortingspassen die gebruikt zijn maar nog niet gecontroleerd/goedgekeurd zijn. De melding "heeft te veel betaald" gaf soms een vals alarm wanneer er al een (nog te verwerken) terugbetaling voor klaarstond — dit is gecorrigeerd. Meldingen ouder dan 6 maanden worden niet langer getoond, en de mail wordt voortaan om 07:00 uur verstuurd in plaats van 07:30.

  - **Kortingen — Automatische korting op woonplaats werkte niet bij een bestaand cursistaccount**: Bij het afrekenen werd de ingevulde woonplaats (en adres, postcode, telefoonnummer en land) alleen opgeslagen bij het aanmaken van een nieuw cursistaccount. Bij een bestaand account werd bij een nieuwe bestelling alleen de geboortedatum bijgewerkt; de zojuist ingevulde woonplaats werd genegeerd en de oude (mogelijk lege) waarde bleef staan. Hierdoor kon een automatische korting met de voorwaarde "woonplaats is Utrecht" ten onrechte niet worden toegepast bij cursisten die al eerder een account hadden. Deze gegevens worden nu ook bijgewerkt bij een bestaand account.

  - **Kortingen — Automatische korting op woonplaats werd nog steeds gemist bij een nieuw cursistaccount**: Ook na de vorige correctie kon het gebeuren dat de automatische korting op woonplaats (bijv. "woonplaats is Utrecht") niet werd toegepast bij een cursist die nog geen account had: stap 2 van het bestelproces controleerde de woonplaats via het zojuist aangemaakte cursistaccount, en dat account bleek op dat moment soms nog niet (volledig) beschikbaar voor die controle. Stap 2 toetst de voorwaarde nu rechtstreeks aan de woonplaats die de cursist in stap 1 heeft ingevuld, in plaats van aan het cursistaccount, waardoor de korting altijd meteen correct wordt toegepast.
  ...
  - **Programmaoverzicht — Bewerkknop opende verkeerd programma na sorteren op cursusnaam**: Bij het sorteren van het programmaoverzicht op de kolom "Cursus" werd een technische koppeling gelegd met de cursustabel, waardoor het ID achter de bewerkknop van een rij per ongeluk het ID van een cursus kon zijn in plaats van het ID van het programma zelf. Hierdoor kon een klik op "Bewerken" na het sorteren op cursusnaam bij een ander (willekeurig) programma uitkomen. Dit is verholpen; sorteren op cursusnaam laat de bewerkknoppen nu altijd naar het juiste programma verwijzen.

  - **Moodle-synchronisatie — Aanmaken account mislukte zonder voornaam of achternaam**: Wanneer een cursist geen voornaam en/of achternaam had, mislukte het aanmaken van het bijbehorende account in Moodle. Een ontbrekende of lege voornaam/achternaam wordt nu vervangen door "Onbekend", zodat het account altijd aangemaakt kan worden.

  - **Zoekresultaten — Producten ontbraken bij de meeste thema's**: De zoekfunctie op het cursusoverzicht bouwde achter de schermen al een gecombineerde, op relevantie gesorteerde lijst van cursussen én producten op, maar de meeste thema's (Breda, Demo, Gouda, Utrecht, Vudemo, Westvoorne) toonden alleen de cursussen uit die lijst. Producten die op titel, omschrijving of intro overeenkwamen met de zoekterm verschenen daardoor niet in de zoekresultaten, terwijl ze op collectiepagina's wel gewoon zichtbaar zijn. Alle thema's tonen nu ook producten in de zoekresultaten, op dezelfde manier als op collectiepagina's.

  - **E-Boekhouden-synchronisatie — Bedragen werden exclusief BTW verstuurd**: De dagelijkse synchronisatie haalde het BTW-bedrag van elke factuur af voordat de mutatie naar e-Boekhouden werd verstuurd, terwijl er wel een BTW-code werd meegestuurd. Hierdoor kwamen bedragen exclusief BTW binnen in e-Boekhouden. De synchronisatie stuurt nu het volledige factuurbedrag inclusief BTW, samen met de juiste BTW-code, zodat e-Boekhouden de BTW correct berekent en registreert.

  ### 🎨 Thema-updates Breda

  - **Checkout — Land vóór postcode**: In stap 1 van het bestelproces stond het land-keuzeveld ná postcode en plaats. De volgorde is aangepast naar: straat + huisnummer, land, postcode, plaats.

  - **Cursus- en productkaarten — Productlabel verplaatst**: Op productkaarten (cursusoverzicht en collectiepagina's) stond een label "Product" over de afbeelding heen, en nogmaals als vaste tekst naast de titel. Het label over de afbeelding is verwijderd; naast de titel staat nu het producttype in plaats van het woord "Product", op dezelfde manier als bij cursussen.

  - **Homepage — "Populair en trending" nu een samengestelde collectie**: Dit blok toonde voorheen automatisch de 6 cursussen met de meeste favorieten. Het toont nu de inhoud van de collectie "Populair en trending" (collectie-ID 69), in de volgorde die voor die collectie is ingesteld, inclusief eventuele producten.
